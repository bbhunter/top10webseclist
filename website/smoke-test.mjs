...
const deploymentChecks = [
  ...
  indexSource.includes('href="styles.css?v=20260817.1"') && indexSource.includes('src="app.js?v=20260817.1"'),
  indexSource.includes('id="mobile-menu-backdrop"'),
  appSource.includes('$("#mobile-menu-backdrop").addEventListener("click", () => setMobileMenuOpen(false))'),
