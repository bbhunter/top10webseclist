...
-   [Multiple Browsers Cross Domain Charset Inheritance](https://seclists.org/fulldisclosure/2007/Feb/548) — Stefan Esser
-   [Windows DNS Server Cache Poisoning](https://dl.packetstormsecurity.net/papers/attack/Windows_DNS_Cache_Poisoning.pdf) — Amit Klein
-   [A Taxonomy of Attacks against XML Digital Signatures & Encryption](https://blackhat.com/presentations/bh-usa-07/Hill/Whitepaper/bh-usa-07-hill-WP.pdf) — Brad Hill
-   [The Little Hybrid Web Worm that Could](https://www.blackhat.com/presentations/bh-usa-07/Hoffman_and_Terrill/Whitepaper/bh-usa-07-hoffman_and_terrill-WP.pdf) — Billy Hoffman and John Terrill
