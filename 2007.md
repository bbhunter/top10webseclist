...
> skill, and scored **60 or above** with a non-duplicate
> verdict before being added here. The judge score and verdict are noted per
> entry. Added 2026-08-07 and expanded for the 60-point gate on 2026-08-08 via
> the `webseclist-find-missed` skill.

-   [Exposing Private Information by Timing Web Applications](https://crypto.stanford.edu/~dabo/pubs/abstracts/webtiming.html) [Paper](https://archives.iw3c2.org/www2007/papers/paper555.pdf) — **judge 78.2/100**, original technique (introduces cross-site timing) — Andrew Bortz, Dan Boneh, Palash Nandy (Stanford, WWW 2007)
-   [Heap Feng Shui in JavaScript](https://www.blackhat.com/presentations/bh-europe-07/Sotirov/Whitepaper/bh-eu-07-sotirov-WP.pdf) [Slides](https://www.blackhat.com/presentations/bh-europe-07/Sotirov/Presentation/bh-eu-07-sotirov-apr19.pdf) — **judge 84.8/100**, original technique (precise JavaScript heap grooming beyond heap spray) — Alexander Sotirov (Black Hat Europe 2007)
-   [The ND2DB Attack: Database Content Extraction Using Timing Attacks on the Indexing Algorithms](https://www.usenix.org/legacy/event/woot07/tech/full_papers/futoransky/futoransky.pdf) [Black Hat paper](https://www.blackhat.com/presentations/bh-usa-07/Waissbein_Futoransky_and_Saura/Whitepaper/bh-usa-07-waissbein_futoransky_and_saura-WP.pdf) — **judge 71.5/100**, original technique (B-tree insertion timing as a private-data oracle) — Ariel Futoransky, Damián Saura, Ariel Waissbein (WOOT 2007)
-   [Protecting Browsers from Frame Hijacking Attacks](https://seclab.stanford.edu/websec/frames/) [WebKit disclosure](https://bugs.webkit.org/show_bug.cgi?id=15936) — **judge 69.3/100**, meaningful extension (modern frame-navigation attacks and the descendant policy, extending a 1999 primitive) — Adam Barth, Collin Jackson (Stanford, December 2007)
-   [JavaScript Hijacking](https://seclists.org/securecoding/2007/q2/0) [Whitepaper](https://img2.helpnetsecurity.com/dl/articles/JavaScript_Hijacking.pdf) — **judge 68.2/100**, meaningful extension (framework-wide systematisation and mitigation of a 2006 AJAX/JSON interception primitive) — Brian Chess, Yekaterina Tsipenyuk O'Neil, Jacob West (Fortify, March 2007)
-   [The Ghost in the Browser: Analysis of Web-based Malware](https://www.usenix.org/conference/hotbots-07/ghost-browser-analysis-web-based-malware) [Paper](https://www.usenix.org/legacy/event/hotbots07/tech/full_papers/provos/provos.pdf) — **judge 67.7/100**, tooling or methodology contribution (large-scale drive-by-malware ecosystem analysis) — Niels Provos, Dean McNamee, Panayiotis Mavrommatis, Ke Wang, Nagendra Modadugu (Google, HotBots 2007)
-   [CaffeineMonkey: Automated Collection, Detection and Analysis of Malicious JavaScript](https://blackhat.com/presentations/bh-usa-07/Feinstein_and_Peck/Presentation/bh-usa-07-feinstein_and_peck.pdf) — **judge 66.5/100**, tooling or methodology contribution (instrumented-runtime JavaScript deobfuscation at scale) — Ben Feinstein, Daniel Peck (SecureWorks, Black Hat USA 2007)
-   [An Analysis of Browser Domain-Isolation Bugs and a Light-Weight Transparent Defense Mechanism](https://www.microsoft.com/en-us/research/?p=153771) [Paper](https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/ScriptAccenting.pdf) — **judge 64.8/100**, tooling or methodology contribution (cross-case isolation analysis and script accenting) — Shuo Chen, David Ross, Yi-Min Wang (Microsoft Research, CCS 2007)
-   [Transaction Generators: Root Kits for Web](https://www.usenix.org/conference/hotsec-07/transaction-generators-root-kits-web) [Paper](https://www.usenix.org/legacy/event/hotsec07/tech/full_papers/jackson/jackson.pdf) — **judge 64.5/100**, meaningful combination or adaptation (client-resident post-authentication transaction abuse and confirmation model) — Collin Jackson, Dan Boneh, John C. Mitchell (Stanford, HotSec 2007)
