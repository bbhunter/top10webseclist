...
-   [Multiple Browsers Cross Domain Charset Inheritance](https://seclists.org/fulldisclosure/2007/Feb/548) — **judge 76.6/100**, Meaningful combination or adaptation — Stefan Esser
-   [Windows DNS Server Cache Poisoning](https://dl.packetstormsecurity.net/papers/attack/Windows_DNS_Cache_Poisoning.pdf) — **judge 66.1/100**, Meaningful extension — Amit Klein
