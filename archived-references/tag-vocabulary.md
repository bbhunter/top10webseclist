...
| `deserialization` | 87 | A08:2021 |
| `desync` | 36 | — |
| `detection` | 130 | A09:2021 |
| `django` | 11 | — |
| `dns` | 94 | — |
| `dns-rebinding` | 35 | A10:2021 |
| `docker` | 6 | A05:2021 |
| `dom` | 148 | — |
...
| `file-upload` | 94 | — |
| `file-write` | 4 | — |
| `filter-bypass` | 314 | A05:2021 |
| `flash` | 57 | — |
| `flask` | 6 | — |
| `formal-analysis` | 36 | — |
| `ftp` | 10 | — |
| `fuzzing` | 63 | — |
| `gadget-chain` | 106 | A08:2021 |
| `gcp` | 11 | — |
| `github` | 24 | — |
...
| `prompt-injection` | 45 | A03:2021 |
| `prototype-pollution` | 27 | A08:2021 |
| `proxy` | 85 | — |
| `python` | 40 | — |
...
Review these before reusing them: `active-directory`, `blind-xss`, `clipboard`, `dependency-confusion`, `html5`, `smb`, `subdomain-takeover`, `symfony`, `type-confusion`, `vue`
