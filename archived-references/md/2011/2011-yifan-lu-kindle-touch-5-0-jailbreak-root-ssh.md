...
tags: [article, webseclist-reference, en, yifan-lu, javascript, rce, injection, privilege-escalation, sandbox-escape, novel-technique, case-study, owasp-a01-2021, owasp-a03-2021]
generated:
...
cited_by:
  - "2011.md:24"
commit: ""
content_sha256: 68d3a356caecc066b6de47a154e11276b5f4d738c566da5883aafea1c27b2038
depth: full
depth_reason: default
kind: article
language: en
licence: unknown
original_url: "http://yifan.lu/2011/12/10/kindle-touch-5-0-jailbreakroot-and-ssh/"
...
slug: 2011-yifan-lu-kindle-touch-5-0-jailbreak-root-ssh
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
**Obtaining the root image** Before we can look for vulnerabilities in the system that would allow us to break in, we need to break into the system and obtain the files that might contain vulnerabilities. Yes, this is a chicken-and-egg problem, but fortunately Amazon is nice enough to help us with this. On every Kindle device is a TTL serial port. I [found this port](http://yifan.lu/wp-content/uploads/2011/12/serial_port.jpg) on the bottom of the device when the [cover is opened](http://www.mobileread.com/forums/showpost.php?p=1863158&postcount=191). Fortunately, I did not even have to mess with it, as **hondamarlboro** and **ramirami **both managed to get the dump before me. Once we have the root image, it was only a matter of painstakingly looking through all the files to see possible injection vectors.
...
[Download the jailbreak here](http://yifan.lu/p/kindle-touch-jailbreak)
