...
tags: [whitepaper, webseclist-reference, flash, same-origin-policy, sop-bypass, cors, csrf, javascript, mitigation, novel-technique, survey, owasp-a01-2021]
generated:
...
cited_by:
  - "2011.md:9"
commit: ""
content_sha256: c35f44b9e67ce0150ad9e572419a6357692215edc95375b8e4e76cc613e1c694
depth: full
...
retrieved_utc: "2026-08-14T22:37:08+00:00"
...
- Preserved from: http://polyboy.net/docs/2011_DIMVA_Flash_crossdomain_proxies.pdf (manual-import) on 2026-08-14
- Licence: unknown
          ...
          A closer look at client-side Flash proxies for cross-domain requests      5
             ...
             D#E#5;(9F*&                      !"#$%&
               ...
               G#$%H.+B6/()#0N$*#*)&1&A66C&
                    ...
                    '#""&IF)/&=)*%60&             '()#*)&+),-)$*&.#/0")(&
                G#$%H.+B6F)/3JK>LJM&-("4C&       %#/0")(1&/)2&.#/0")(3-("4&
...
2
    ...
    the issue [29]. Besides that, there appears to be no awareness.
          A closer look at client-side Flash proxies for cross-domain requests    7
...
can fake the location of his page and make flXHR believe that the enclosing origin
matches its own.
    As we will discuss further in Section 5.1, with the ExternalInterface API it
is not possible to fix this problem, because it only allows to call public JavaScript
...
hence, is unable to execute the attack.
...
14        Martin Johns, Sebastian Lekies
...
request).
4
     We tested this behavior with the following browsers: Firefox, Internet Explorer,
...
and the URLs are equal and, thus, can conclude that the first URL received
from JavaScript was indeed correct (see Listing 5).
         ...
         O#:#G5(8M*&                       !"#$%&
           ...
           '()#*)&'(6$$&H67#8/&+),-)$*&
            ...
            P#$%Q.+<6/()#0X$*#*)&1&K66D&             '()#*)&+),-)$*&.#/0")(&&
                 ...
                 '#""&RM)/&;)*%60&            '#"5-"#*)&+#/067&#/0&+)08()5*&9(62$)(&
             P#$%Q.+<6M)/3BSTFBU&-("4D&           :#(&(#/067&1&;#*%<(#/06734&=&/&
                                                   >#(&?($*@("1&-("&A&BCB&A&(#/067D&
                                                       /#:8E#*)F6@("3?($*@("4D&


                 '#""&G)/0&;)*%60&                         ?($*@+I&11&            N6&   ;#/8M-"#J6/&0)*)5*)0&
                 P#$%Q.+<$)/034D&                         "65#J6/<%()K&

                                                                   L)$&
                 '#""V#5W&;)*%60&
                  K663()$M6/$)4D&                   G)/0&'(6$$&H67#8/&+),-)$*&
