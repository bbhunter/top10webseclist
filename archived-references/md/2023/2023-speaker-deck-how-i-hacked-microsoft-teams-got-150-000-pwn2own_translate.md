...
slug: 2023-speaker-deck-how-i-hacked-microsoft-teams-got-150-000-pwn2own_translate
snapshot: ""
title_english: ""
translation_file: ""
translation_of: 2023-speaker-deck-how-i-hacked-microsoft-teams-got-150-000-pwn2own.md
---

# How I Hacked Microsoft Teams and got $150,000 in Pwn2Own (English translation)
...
_Machine translation of [`2023-speaker-deck-how-i-hacked-microsoft-teams-got-150-000-pwn2own.md`](2023-speaker-deck-how-i-hacked-microsoft-teams-got-150-000-pwn2own.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
...
Japanese version is here: [https://speakerdeck.com/masatokinugawa/shibuya-dot-xss-techtalk-number-12](https://speakerdeck.com/masatokinugawa/shibuya-dot-xss-techtalk-number-12)
...
Shadow DOM and Security — Exploring the Boundary Between Light and Shadow / Shibuya.XSS techtalk #13
...
Appreciating Browsers' Legacy and Proprietary Features — Four Firefox Vulnerabilities — / Browser Crash Club #1
...
Two Client-Side Vulnerabilities Worth Watching / Security.Tokyo #3
...
An Encouragement to Try Bug Hunting / P3NFEST
...
How I Hacked Microsoft Teams at Pwn2Own and Won 20 Million Yen / Shibuya.XSS techtalk #12
...
DoS with JS / Shibuya.XSS techtalk #11
...
Arbitrary Code Execution by Exploiting the Lack of Context Isolation in Electron / Electron: Abusing the lack of context isolation - CureCon(ja)
...
【CEDEC2026】A Creative Approach to Localizing Character Dialects and Speech Styles in the English Version of Umamusume: Pretty Derby
...
【Google Cloud Next Tokyo'26】Implementing AI Agents That Enable Business Data Utilization with Gemini Enterprise and Oracle AI Database
...
Hands-On Product Security Training for the AI Era Through Attack and Defense
...
【CEDEC2026】Server Design and Operations for a Next-Generation Digital Card Game — Behind the Scenes of Shadowverse: Worlds Beyond —
...
Toward a World Where AI Operates Your Company's Tableau: A Beginner's Guide to Tableau MCP
...
How Do You Establish SRE in an Organization? — The Case of IVRy —
...
Why an AI-Native Organization Needs the Gemini Enterprise Agent Platform
...
Introduction to Web Accessibility 2026
...
Cyber Investigator Training (Second Half)
...
【CEDEC2026】Introduction to Neural Shading for Graphics Engineers
