...
tags: [article, webseclist-reference, en, ryan, csrf, info-leak, injection, dom, javascript, rails, attack-chain, novel-technique]
generated:
...
cited_by:
  - "2023.md:29"
commit: ""
content_sha256: 0e28bf4347a4c150f0e9e21c72ec8d4469ad3b42e5ad711382c3ac91c9daa293
depth: full
depth_reason: default
kind: article
language: en
licence: unknown
original_url: "https://bountyplz.xyz/bugbounty/2023/07/30/HTML-Over-The-Wire.html"
published: 2023-07-30
publisher: ~ryan
publisher_english: ""
raw_sha256: b9cc8e5c2fb384f99ec79fc9403524a48262f1894de93f107c11af1ff9f6f028
retrieved_from: "https://bountyplz.xyz/bugbounty/2023/07/30/HTML-Over-The-Wire.html"
retrieved_kind: live
retrieved_utc: "2026-08-09T01:07:55+00:00"
slug: 2023-ryan-html-over-wire
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
A lot of web app frameworks will read CSRF tokens from headers. Rails, for example, will read the csrf token from the `x-csrf-token` header, and django will read it from `x-csrftoken`. This is a fairly common convenience for SPA style applications. The framework will embed a  tag containing the token in the HTML so it can be accessed by javascript and attached as a header to fetch requests.
...
Turbo allows you to specify a “turbo-root” directive in a meta tag. This allows you to further restrict what links will be processed by turbo. You set the turbo-root to a local path, and only links to that path will be processed by turbo. At least, that’s how it’s supposed to work according to this documentation: ![image](https://github.com/tehryanx/tehryanx.github.io/assets/8878295/927fea12-5c2f-49a5-b823-3423384bad18)
...
Note in the following image, a request to localhost happily shipped the csrf-token to evil.com. (the 405 error is just because I’m using an instance of node `http-server` that doesn’t accept post requests) ![image](https://github.com/tehryanx/tehryanx.github.io/assets/8878295/1102201e-6593-46dd-bf0c-66f0b25e1ca1)
...
Again note that the HTMX app is running on localhost, but sending the csrf token to evil.com. (again the 405 is just the servers response to any POST req.) ![image](https://github.com/tehryanx/tehryanx.github.io/assets/8878295/01a7a622-3f3d-4b7f-85a4-e751bc68d33c)
