...
slug: synacktiv-php-filter-chains-file-read-error-based-oracle
snapshot: ""
title_english: ""
translation_file: synacktiv-php-filter-chains-file-read-error-based-oracle_translate.md
translation_of: ""
---
...
_The source's own words. An English translation of this document is archived beside it as [`synacktiv-php-filter-chains-file-read-error-based-oracle_translate.md`](synacktiv-php-filter-chains-file-read-error-based-oracle_translate.md)._
...
# PHP filter chains: file read from error-based oracle
 ...
 Rédigé par Rémi Matasse - 21/03/2023 - dans Pentest  - [Téléchargement](https://www.synacktiv.com/publications/php-filter-chains-file-read-from-error-based-oracle)
