...
tags: [article, webseclist-reference, portswigger-research, prototype-pollution, nodejs, express, detection, rce, cors, tooling, novel-technique, owasp-a01-2021, owasp-a08-2021, owasp-a09-2021]
generated:
...
language: ""
licence: unknown
original_url: "https://portswigger.net/research/server-side-prototype-pollution"
...
-
 ...
 ![A picture of a man in a car with a pirate flag with lots of exhaust fumes and prototype pollution detection vectors in them](https://portswigger.net/cms/images/14/b4/9ea7-article-server_side_prototype_pollution_blog-article.png)

**Server-side [prototype pollution](https://portswigger.net/web-security/prototype-pollution) is hard to detect black-box without causing a DoS. In this post, we introduce a range of safe detection techniques, which we've also implemented in an open source Burp Suite extension. You can shortly try these out for yourself on interactive, deliberately vulnerable labs in our new Web Security Academy topic.**
...
![JavaScript prototype chain](https://portswigger.net/cms/images/51/a2/3689-article-prototype-pollution-prototype-chain.svg)
...
![Vulnerable merge operation](https://portswigger.net/cms/images/4a/e7/b7c2-article-vulnerable-libraries.png)
...
![Encoding property exception](https://portswigger.net/cms/images/08/d5/0d88-article-001-encoding-property-pp.png)
...
![Modifying the Object constructor keys() method](https://portswigger.net/cms/images/a9/a2/f0b3-article-002-object-keys-pp.png)
...
![Expect technique](https://portswigger.net/cms/images/e5/99/edd6-article-003-expect-property-pp.png)
...
![Stored XSS via prototype pollution](https://portswigger.net/cms/images/45/d6/3efa-article-004-stored-xss-pp.png)

By polluting both the `body` and `_body` properties, i could cause Express to serve up the HTML content type and reflect the `_body` property, resulting in [stored XSS](https://portswigger.net/web-security/cross-site-scripting/stored). As you might have guessed, the only problem with this is the XSS payload is always served, thus making it a destructive technique that is not suitable for prototype pollution detection.
...
![Parameter limit](https://portswigger.net/cms/images/65/2d/2938-article-005-parameter-limit.png)
...
![Ignore query prefix technique](https://portswigger.net/cms/images/91/3e/4a55-article-006-multiple-question-marks-pp.png)
...
![Allow dots technique](https://portswigger.net/cms/images/ae/4d/86bd-article-007-parameter-into-object-pp.png)
...
![Content type technique](https://portswigger.net/cms/images/fa/fd/2afb-article-008-charset-json-pp.png)
...
![JSON spaces technique](https://portswigger.net/cms/images/b7/b1/2e29-article-009-json-padding-pp.png)
...
![Status technique](https://portswigger.net/cms/images/40/2b/8865-article-011-status-pp.png)
...
![OPTIONS technique](https://portswigger.net/cms/images/2d/af/48dc-article-012-change-options-pp.png)
...
![Reflection technique](https://portswigger.net/cms/images/ec/fe/22ba-article-013-reflection-pp.png)
...
![Excluded properties technique](https://portswigger.net/cms/images/7e/13/9443-article-014-excluded-properties-pp.png)
...
![Immutable prototype technique](https://portswigger.net/cms/images/50/ca/d1db-article-015-generic-detection-pp.png)
...
![Native code reflection](https://portswigger.net/cms/images/87/bb/5afe-article-016-native-code-reflection.png)
...
![Detecting the JavaScript engine](https://portswigger.net/cms/images/86/80/6de7-article-017-detect-engine-pp.png)
