...
cited_by:
  - "2023.md:49"
commit: ""
content_sha256: cde92aa1dda42624d1ea993fbac9bb279712a8ba3d96158894ef95b9b7467af5
depth: full
depth_reason: default
kind: article
language: en
licence: unknown
original_url: "https://sec-consult.com/blog/detail/dns-analyzer-finding-dns-vulnerabilities-with-burp-suite/"
published: ""
...
![Analyzing web applications via Burp Collaborator & DNS Analyzer](https://sec-consult.com/fileadmin/_processed_/4/0/csm_sec-consult-h-Burp_Collaborater_c3b21dc5ea.png)
...
[![Redirecting e-mails for password resets via DNS cache poisoning](https://sec-consult.com/fileadmin/_processed_/f/4/csm_sec-consult-c-Web_app_DNS_resolver_97758f4660.png)](https://sec-consult.com/fileadmin/_processed_/f/4/csm_sec-consult-c-Web_app_DNS_resolver_acb5a6802f.png)
...
[![Analyzing web applications via DNS Analysis Server](https://sec-consult.com/fileadmin/_processed_/b/1/csm_sec-consult-c-ADNS_analysis_example_2620174ce7.png)](https://sec-consult.com/fileadmin/_processed_/b/1/csm_sec-consult-c-ADNS_analysis_example_eda80b8da1.png)
...
[![Analyzing web applications via Burp Collaborator & DNS Analyzer](https://sec-consult.com/fileadmin/_processed_/f/0/csm_sec-consult-c-Burp_Collaborater_and_DNS_resolver_c7d3a7278b.png)](https://sec-consult.com/fileadmin/_processed_/f/0/csm_sec-consult-c-Burp_Collaborater_and_DNS_resolver_9139845932.png)
...
- The DNS resolver then tries to resolve the **MX record of 0100001337.analysis.example **by querying the authoritative DNS nameserver (ADNS) of **analysis.example**. This ADNS runs the [DNS Analysis Server](https://github.com/The-Login/DNS-Analysis-Server), which **actively **and **passively **analyzes the DNS resolver for security issues. For example, it **actively **returns manipulated DNS responses to the DNS resolver and it **passively **logs security-relevant data such as used UDP source ports.
- After the [DNS Analysis Server](https://github.com/The-Login/DNS-Analysis-Server) has analyzed enough DNS traffic, a log analyzer can be used to process and visualize the results.
...
![GIF showing Click "Copy to Clipboard"](https://sec-consult.com/fileadmin/user_upload/sec-consult/Dynamisch/Blogartikel/2023_06/sec-consult-c-Copy_to_Clipboard.gif)

- In the first step, we again force the web application to resolve a specific domain name. However, in this case, we are using a collaborator domain **r6havapn933jvdt.oastify.com** which was generated by the [DNS Analyzer](https://github.com/The-Login/DNS-Analyzer).
- Like before, the web application tries to resolve this domain name and sends a DNS query to the configured DNS resolver.
- Now, the Burp Collaborator comes into play! The Collaborator server **passively **logs the query from the DNS resolver and returns - contrary to the [DNS Analysis Server](https://github.com/The-Login/DNS-Analysis-Server) - a non-manipulated DNS response.
- The DNS interactions received by the Collaborator server can then be analyzed in the [DNS Analyzer](https://github.com/The-Login/DNS-Analyzer) extension.
- Based on the results, the tester can trigger further DNS resolutions via registration, password reset, newsletter, etc..
...
![GIF showing Trigger a DNS resolution](https://sec-consult.com/fileadmin/user_upload/sec-consult/Dynamisch/Blogartikel/2023_06/sec-consult-c-register.gif)
...
![GIF showing Table Entries](https://sec-consult.com/fileadmin/user_upload/sec-consult/Dynamisch/Blogartikel/2023_06/sec-consult-c-Table_Entries.gif)
...
![GIF showing Selecting Interactions](https://sec-consult.com/fileadmin/user_upload/sec-consult/Dynamisch/Blogartikel/2023_06/sec-consult-c-Selecting_Interactions.gif)
...
[![Scatter Plots](https://sec-consult.com/fileadmin/_processed_/d/6/csm_sec-consult-c-scatter_plots_9017a6fa77.png)](https://sec-consult.com/fileadmin/user_upload/sec-consult/Dynamisch/Blogartikel/2023_06/sec-consult-c-scatter_plots.png)
...
[![Scatter Plots](https://sec-consult.com/fileadmin/_processed_/a/c/csm_sec-consult-c-scatter_plots_02_cf8284fb00.png)](https://sec-consult.com/fileadmin/user_upload/sec-consult/Dynamisch/Blogartikel/2023_06/sec-consult-c-scatter_plots_02.png)
...
[![Scatter Plots](https://sec-consult.com/fileadmin/_processed_/c/3/csm_sec-consult-c-scatter_plots_03_ccc5fb5204.png)](https://sec-consult.com/fileadmin/user_upload/sec-consult/Dynamisch/Blogartikel/2023_06/sec-consult-c-scatter_plots_03.png)
...
![Static UDP source port values coming from one specific resolver IP](https://sec-consult.com/fileadmin/user_upload/sec-consult/Dynamisch/Blogartikel/2023_06/sec-consult-c-results_sections.gif)
...
[![Statistics and scatter plots of the Google public DNS resolver showing no signs of a vulnerability](https://sec-consult.com/fileadmin/_processed_/d/4/csm_sec-consult-c-scatter_plots_google_arrow_d83e807239.png)](https://sec-consult.com/fileadmin/_processed_/d/4/csm_sec-consult-c-scatter_plots_google_arrow_1bf8562fbc.png)
...
- you've confirmed the vulnerability via in-depth DNS analysis (e.g., via the [DNS-Analysis-Server](https://github.com/The-Login/DNS-Analysis-Server))
