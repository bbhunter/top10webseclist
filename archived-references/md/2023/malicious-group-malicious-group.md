...
retrieved_kind: live
retrieved_utc: "2026-08-09T01:05:45+00:00"
slug: malicious-group-malicious-group
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
# PoC or GTFO.
 ...
 ![Smuggling Through the Front Door... Achieving 0-Click XSS with Cache Poisoning](https://malicious.group/content/images/size/w720/2026/05/comic6-1.png)
...
In this post, I want to walk through how a surviving Azure Front Door desync poisoned platform error pages into a global 0-click XSS. This issue was tracked as VULN-157984, confirmed by Microsoft, fixed, and awarded under the Azure bounty program.
 ...
 ![Smuggling Through the Front Door... Achieving Global Redirect Poisoning at the Edge](https://malicious.group/content/images/size/w720/2026/05/comic5.png)
...
In this post, I want to walk through a request smuggling bug chain I reported to MSRC that affected Azure Front Door. This issue was tracked as VULN-152925, confirmed by Microsoft, fixed, and awarded under the Azure bounty program.
 ...
 ](https://malicious.group/smuggling-through-the-front-door-achieving-global-redirect-poisoning-at-the-edge/)

 [

 ![HTTP is dead... Long live HTTP?!](https://malicious.group/content/images/size/w720/2026/06/httpisdeadcover.png)
...
In this post, I will continue on my last paper by showing the readers a severe HTTP request smuggling bug chain using a new gadget, as well as a few ways to exploit it.
 ...
 ](https://malicious.group/http-is-dead-long-live-http/)

 ◆ Top 10 Web Attacks 2023 #8

 [

 ![From Akamai to F5 to NTLM... with love.](https://malicious.group/content/images/size/w720/2026/05/comic-1.png)
...
In this post, I am going to show the readers how I was able to abuse Akamai so I could abuse F5 to steal internal data including authorization and session tokens from their customers.
 ...
 ](https://malicious.group/from-akamai-to-f5-to-ntlm/)

 [

 ![Inline Assembly](https://malicious.group/content/images/size/w720/2023/05/inline-assembly.png)
...
In this post, we will cover introductory concepts regarding the usage of inline assembly. We'll look at what we mean by inline assembly, how to use inline assembly and some examples of inline assembly usage.
 ...
 ](https://malicious.group/inline-assembly/)

 [

 ![Writing your own RDI /sRDI loader using C and ASM](https://malicious.group/content/images/size/w720/2023/04/rdi-srdi.png)
...
In this post, I am going to show the readers how to write their own RDI/sRDI loader in C, and then show how to optimize the code to make it fully position independent.
 ...
 ](https://malicious.group/writing-your-own-rdi-srdi-loader-using-c-and-asm/)

 [

 ![Automating C2 Infrastructure with Terraform, Nebula, Caddy and Cobalt Strike](https://malicious.group/content/images/size/w720/2022/09/featured-3.png)
...
In this post, I am going to show the readers how to build a fully automated C2 infrastructure using Terraform with Nebula's end-to-end encryption backend communication layer.
 ...
 ](https://malicious.group/automating-c2-infrastructure-with-terraform-nebula-caddy-and-cobalt-strike/)
