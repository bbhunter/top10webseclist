...
cs.CR
  ...
  [< prev](https://arxiv.org/prevnext?id=2605.22333&function=prev&context=cs.CR)   |   [next >](https://arxiv.org/prevnext?id=2605.22333&function=next&context=cs.CR)

 [new](https://arxiv.org/list/cs.CR/new)  |  [recent](https://arxiv.org/list/cs.CR/recent)  | [2026-05](https://arxiv.org/list/cs.CR/2026-05)

 Change to browse by:

 [cs](https://arxiv.org/abs/2605.22333?context=cs)

### References & Citations

- [NASA ADS](https://ui.adsabs.harvard.edu/abs/arXiv:2605.22333)
- [Google Scholar](https://scholar.google.com/scholar_lookup?arxiv_id=2605.22333)
- [Semantic Scholar](https://api.semanticscholar.org/arXiv:2605.22333)

 export BibTeX citation

### Bookmark

[ ![BibSonomy](https://arxiv.org/static/browse/0.3.4/images/icons/social/bibsonomy.png) ](http://www.bibsonomy.org/BibtexHandler?requTask=upload&url=https://arxiv.org/abs/2605.22333&description=A First Measurement Study on Authentication Security in Real-World Remote MCP Servers) [ ![Reddit](https://arxiv.org/static/browse/0.3.4/images/icons/social/reddit.png) ](https://reddit.com/submit?url=https://arxiv.org/abs/2605.22333&title=A First Measurement Study on Authentication Security in Real-World Remote MCP Servers)
