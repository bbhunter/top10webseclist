---
type: Article
title: Two Bypasses for Chrome’s Sanitizer API › Searchlight Cyber
...
**Two Bypasses for Chrome’s Sanitizer API › Searchlight Cyber** - Adam Kues, @searchlightsec, Searchlight Cyber.
