...
tags: [article, webseclist-reference, en, harel-security-research, xss, cookie, oauth, csp, auth-bypass, waf, dos, attack-chain, bug-bounty, owasp-a01-2021, owasp-a03-2021, owasp-a05-2021, owasp-a07-2021]
generated:
...
cited_by:
  - "2024.md:63"
commit: ""
content_sha256: 30efee3ffe20ae1c694c72e789e3ef648a316c3bc2bd2e1aa2b7ffbe0ab30ca7
depth: full
depth_reason: default
kind: article
language: en
licence: unknown
original_url: "https://nokline.github.io/bugbounty/2024/06/07/Zoom-ATO.html"
published: 2024-06-07
publisher: Harel Security Research
publisher_english: ""
raw_sha256: ca9c6b755cbae527348a0bbc41a7a66110abf2e85b28e84e7d0ff2cfd55b2ceb
retrieved_from: "https://nokline.github.io/bugbounty/2024/06/07/Zoom-ATO.html"
retrieved_kind: live
retrieved_utc: "2026-08-09T01:37:10+00:00"
slug: 2024-harel-security-research-zoom-session-takeover-cookie-tossing-abuse
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
**Request Cookie:** `Cookie: _zm_csp_script_nonce=test">alert(1)//`
 **Response CSP:** `content-security-policy: script-src 'nonce-5XTGYai_PTRYUB145'`
 **Response HTML:** `<script nonce="5XTGYai_PTRYUB145">...</script>`
...
And the second one `_zm_o2state` doesn’t seem like an encoded string, so what is it really? Looking at the state parameter value from Google OAuth URL `state=RmFJTE1jM0JUTkNnWWVOS2c1THpNQSxnb29nbGVfc2lnbmlu`, trying to base64 decode gives us this:
