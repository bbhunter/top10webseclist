...
tags: [article, webseclist-reference, en, gmo-flatt-security-research, race-condition, http2, auth-bypass, http, tooling, prior-art-extension, nodejs, owasp-a01-2021, owasp-a04-2021]
generated:
...
cited_by:
  - "2024.md:41"
commit: ""
content_sha256: 53243c953aa5615982cfc4b689adeee59128dbfffb06a900e24e8ceea7678ea8
depth: full
depth_reason: default
kind: article
language: en
licence: unknown
original_url: "https://flatt.tech/research/posts/beyond-the-limit-expanding-single-packet-race-condition-with-first-sequence-sync/"
published: 2024-08-02
publisher: GMO Flatt Security Research
publisher_english: ""
raw_sha256: 006fadb782cba4f74a2847dc965293c53878db6fc0be16ecb37aa622ee826208
retrieved_from: "https://flatt.tech/research/posts/beyond-the-limit-expanding-single-packet-race-condition-with-first-sequence-sync/"
retrieved_kind: live
retrieved_utc: "2026-08-09T01:10:34+00:00"
slug: 2024-gmo-flatt-security-research-beyond-limit-expanding-single-packet-limit
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
In 2023, [James Kettle](https://twitter.com/albinowax) of PortSwigger published [an excellent paper](https://portswigger.net/research/smashing-the-state-machine) titled `Smashing the state machine: the true potential of web race conditions`.
 ...
 ![An image that indicates single-packet bypasses the network jitter](https://flatt.tech/research/beyond-the-limit-expanding-single-packet-race-condition-with-first-sequence-sync/01.png)

*Quoted from [Smashing the state machine: the true potential of web race conditions](https://portswigger.net/research/smashing-the-state-machine)*
...
![An image that shows IP packet is fragmented into multiple frames](https://flatt.tech/research/beyond-the-limit-expanding-single-packet-race-condition-with-first-sequence-sync/04.png)
...
![An image that multiple IP fragments are reassembled into a single IP packet](https://flatt.tech/research/beyond-the-limit-expanding-single-packet-race-condition-with-first-sequence-sync/05.png)
...
![An image that shows the TCP packets are reordered based on the sequence number](https://flatt.tech/research/beyond-the-limit-expanding-single-packet-race-condition-with-first-sequence-sync/06.png)

[https://datatracker.ietf.org/doc/html/rfc9293#section-3.10-8](https://datatracker.ietf.org/doc/html/rfc9293#section-3.10-8)
...
![An image that shows how the server can’t process the packet](https://flatt.tech/research/beyond-the-limit-expanding-single-packet-race-condition-with-first-sequence-sync/07.png)
...
![An image that shows the client sends the first TCP packet](https://flatt.tech/research/beyond-the-limit-expanding-single-packet-race-condition-with-first-sequence-sync/10.png)
...
If you’re interested in learning more, feel free to reach out to us at [https://flatt.tech/en](https://flatt.tech/en) .
