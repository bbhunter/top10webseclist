...
cs.CR
  ...
  [< prev](https://arxiv.org/prevnext?id=1801.02265&function=prev&context=cs.CR)   |   [next >](https://arxiv.org/prevnext?id=1801.02265&function=next&context=cs.CR)

 [new](https://arxiv.org/list/cs.CR/new)  |  [recent](https://arxiv.org/list/cs.CR/recent)  | [2018-01](https://arxiv.org/list/cs.CR/2018-01)

 Change to browse by:

 [cs](https://arxiv.org/abs/1801.02265?context=cs)

### References & Citations

- [NASA ADS](https://ui.adsabs.harvard.edu/abs/arXiv:1801.02265)
- [Google Scholar](https://scholar.google.com/scholar_lookup?arxiv_id=1801.02265)
- [Semantic Scholar](https://api.semanticscholar.org/arXiv:1801.02265)

### [DBLP](https://dblp.uni-trier.de) - CS Bibliography

 [listing](https://dblp.uni-trier.de/db/journals/corr/corr1801.html#abs-1801-02265) | [bibtex](https://dblp.uni-trier.de/rec/bibtex/journals/corr/abs-1801-02265)

 [Payap Sirinam](https://dblp.uni-trier.de/search/author?author=Payap%20Sirinam)
[Mohsen Imani](https://dblp.uni-trier.de/search/author?author=Mohsen%20Imani)
[Marc Juárez](https://dblp.uni-trier.de/search/author?author=Marc%20Ju%C3%A1rez)
[Matthew Wright](https://dblp.uni-trier.de/search/author?author=Matthew%20Wright)

 export BibTeX citation

### Bookmark

[ ![BibSonomy](https://arxiv.org/static/browse/0.3.4/images/icons/social/bibsonomy.png) ](http://www.bibsonomy.org/BibtexHandler?requTask=upload&url=https://arxiv.org/abs/1801.02265&description=Deep Fingerprinting: Undermining Website Fingerprinting Defenses with Deep Learning) [ ![Reddit](https://arxiv.org/static/browse/0.3.4/images/icons/social/reddit.png) ](https://reddit.com/submit?url=https://arxiv.org/abs/1801.02265&title=Deep Fingerprinting: Undermining Website Fingerprinting Defenses with Deep Learning)
