...
tags: [article, webseclist-reference, en, sambuz, deserialization, sqli, rce, gadget-chain, php, wordpress, cache, owasp-a03-2021, owasp-a08-2021]
generated:
...
![p r e p a r e i n t r o d u c i n g n o v e l e x p l o i](https://c.sambuz.com/910240/p-r-e-p-a-r-e-i-n-t-r-o-d-u-c-i-n-g-n-o-v-e-l-e-x-p-l-o-i-l.webp)
 ...
 [ ** Report Issue ](https://www.sambuz.com/dmca)

P r e p a r e ( ) : I n t r o d u c i n g n o  - - PowerPoint PPT Presentation

Oct 23, 2022 116 likes •493 views
...
---
 ...
 ![slide-1](https://www.sambuz.com/pre.svg)
...
Robin Peraglie
 ...
 ![slide-2](https://www.sambuz.com/pre.svg)
...
Robin Peraglie
 ...
 ![slide-3](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-4](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-5](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-6](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-7](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-8](https://www.sambuz.com/pre.svg)
...
$query = $wpdb->prepare( "SELECT * FROM table WHERE column1 = %s", $_GET['c1'] ); $wpdb->query( $query );
 ...
 ![slide-9](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-10](https://www.sambuz.com/pre.svg)
...
$query = $wpdb->prepare( "SELECT * FROM table WHERE column1 = %s", $_GET['c1'] ); $query = $wpdb->prepare( $query . " AND column2 = %s", $_GET['c2'] ); $wpdb->query( $query );
 ...
 ![slide-11](https://www.sambuz.com/pre.svg)
...
$query = $wpdb->prepare( "SELECT * FROM table WHERE column1 = %s", $_GET['c1'] ); $query = $wpdb->prepare( $query . " AND column2 = %s", $_GET['c2'] ); $wpdb->query( $query );
 ...
 ![slide-12](https://www.sambuz.com/pre.svg)
...
$query = $wpdb->prepare( "SELECT * FROM table WHERE column1 = %s", $_GET['c1'] ); $query = $wpdb->prepare( $query . " AND column2 = %s", $_GET['c2'] ); $wpdb->query( $query );
 ...
 ![slide-13](https://www.sambuz.com/pre.svg)
...
$query = $wpdb->prepare( "SELECT * FROM table WHERE column1 = %s", $_GET['c1'] ); $query = $wpdb->prepare( $query . " AND column2 = %s", $_GET['c2'] ); $wpdb->query( $query );
 ...
 ![slide-14](https://www.sambuz.com/pre.svg)
...
$query = $wpdb->prepare( "SELECT * FROM table WHERE column1 = %s", $_GET['c1'] ); $query = $wpdb->prepare( $query . " AND column2 = %s", $_GET['c2'] ); $wpdb->query( $query );
 ...
 ![slide-15](https://www.sambuz.com/pre.svg)
...
function prepare($query, $args) { if(is_array($args[0])) $args = $args[0]; $query = preg_replace( '/%s/', "'%s'", $query ); array_walk($args, array( $this, 'esc_sql' ) ); $query = vsprintf($query, $args); return str_replace('%', $this->placeholder_escape(), $query); } function query($query) { $query=str_replace($this->placeholder_escape(), '%', $query); // send $query to database... }
 ...
 ![slide-16](https://www.sambuz.com/pre.svg)
...
$query = $wpdb->prepare( "SELECT * FROM table WHERE column1 = %s", $_GET['c1'] ); $query = $wpdb->prepare( $query . " AND column2 = %s", $_GET['c2'] ); $wpdb->query( $query );
 ...
 ![slide-17](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-18](https://www.sambuz.com/pre.svg)
...
parsed into executes Results and SQL query stored in WP_Query!
 ...
 ![slide-19](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-20](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-21](https://www.sambuz.com/pre.svg)
...
$var serialize($var) Integer: $var = 1; String: $var = ‘hello0WASP‘; Array: $var = array(0=>21,1=>22,23); Object: $var=new stdClass(); $var.a=“b“; i:1; s:10:“hello0WASP“; a:3:{i:0;i:21;i:1;i:22;i:3;i:23;} O:8:“stdClass“:1:{s:1:“a“;s:1:“b“;}
 ...
 ![slide-22](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-23](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-24](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-25](https://www.sambuz.com/pre.svg)
...
serialize() percent-signs are replaced as introduced in prepare!
 ...
 ![slide-26](https://www.sambuz.com/pre.svg)
...
≠
 ...
 ![slide-27](https://www.sambuz.com/pre.svg)
...
O:8:"WP_Query":1:{s:3:"sql";s:100:"SELECT… sku=‘%‘ ";…;s:7:"content";s:11:"somecontent";} 35 ≠
 ...
 ![slide-28](https://www.sambuz.com/pre.svg)
...
O:8:"WP_Query":1:{s:3:"sql";s:100:"SELECT… sku=‘%‘ ";…;s:7:"content";s:11:"somecontent";} 35 ≠ 100
 ...
 ![slide-29](https://www.sambuz.com/pre.svg)
...
O:8:"WP_Query":1:{s:3:"sql";s:100:"SELECT… sku=‘%‘ ";…;s:7:"content";s:11:"somecontent";} 35 ≠ 100
 ...
 ![slide-30](https://www.sambuz.com/pre.svg)
...
O:8:"WP_Query":1:{s:3:"sql";s:100:"SELECT… sku=‘%‘ ";…;s:7:"content";s:11:"somecontent";} 35 ≠ 100
 ...
 ![slide-31](https://www.sambuz.com/pre.svg)
...
O:8:"WP_Query":1:{s:3:"sql";s:100:"SELECT… sku=‘%‘ ";…;s:7:"content";s:11:"some";i:0;O:8:"EvilClass":0:{}i:1;s:0:"";} 35 ≠ 100
 ...
 ![slide-32](https://www.sambuz.com/pre.svg)
...
O:8:"WP_Query":1:{s:3:"sql";s:100:"SELECT… sku=‘%‘ ";…;s:7:"content";s:11:"some";i:0;O:8:"EvilClass":0:{}i:1;s:0:"";} 35 ≠ 100 PHP Object Injection!
 ...
 ![slide-33](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-34](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-35](https://www.sambuz.com/pre.svg)
...
## T e c h n i q u e s i n Wo r d P r e s s
 ...
 ![slide-36](https://www.sambuz.com/pre.svg)
