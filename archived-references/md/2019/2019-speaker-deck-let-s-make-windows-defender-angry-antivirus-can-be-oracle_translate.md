...
slug: 2019-speaker-deck-let-s-make-windows-defender-angry-antivirus-can-be-oracle_translate
snapshot: ""
title_english: ""
translation_file: ""
translation_of: 2019-speaker-deck-let-s-make-windows-defender-angry-antivirus-can-be-oracle.md
---

# Let's Make Windows Defender Angry: Antivirus can be an oracle! (English translation)
...
_Machine translation of [`2019-speaker-deck-let-s-make-windows-defender-angry-antivirus-can-be-oracle.md`](2019-speaker-deck-let-s-make-windows-defender-angry-antivirus-can-be-oracle.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
...
A New Attack Technique Against Windows Defender Using Antivirus as an Oracle
...
Introspective Prompt Optimization Through Simultaneous Search for Adversarially Generated Prompts
...
Predicting the Future of Visual SLAM / Future Prediction in Visual SLAM
...
Google Cloud Next 2026 DM Recap, with Agentic Data Cloud / Google Cloud Next 2026 DM Recap
...
Important but Unmeasured: The Invisible Challenges of Elderly Care

 ](https://speakerdeck.com/theoriatec2024/zhong-yao-dakedoce-reteinaimono-gao-ling-zhe-keanojian-enaike-ti)

[ ![Avatar for Theoria Technologies](https://speakerdeck.com/rails/active_storage/representations/redirect/eyJfcmFpbHMiOnsiZGF0YSI6NTg0MDQyLCJwdXIiOiJibG9iX2lkIn19--a11cf3c988ed80f1908eb2616f1acf54295d2e73/eyJfcmFpbHMiOnsiZGF0YSI6eyJmb3JtYXQiOiJwbmciLCJyZXNpemVfdG9fZmlsbCI6WzI0LDI0XX0sInB1ciI6InZhcmlhdGlvbiJ9fQ==--924ecf2834d46e1be7416cc0ef8ce19d4bbdebbf/Theoria_T_blue.png) theoriatec2024 ](https://speakerdeck.com/theoriatec2024)
...
64th CV/PRML Study Group Paper Presentation: Linguistic Priors for Visual Decoupling: Towards Symmetric Vision-Brain Alignment
...
kintone Research Subdepartment / UX Researcher Role Overview
...
12th National Conference Aiming for People- and Environment-Friendly Transportation / Toward “10% Fewer Cars, Half the Congestion, and Twice the Public Transportation” in the Kumamoto Metropolitan Area
...
Building a Team Where Everyone Demonstrates Leadership Regardless of Position / Building a team where everyone can demonstrate leadership regardless of position
