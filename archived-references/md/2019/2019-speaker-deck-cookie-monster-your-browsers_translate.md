...
slug: 2019-speaker-deck-cookie-monster-your-browsers_translate
snapshot: ""
title_english: ""
translation_file: ""
translation_of: 2019-speaker-deck-cookie-monster-your-browsers.md
---

# The Cookie Monster in Your Browsers (English translation)
...
_Machine translation of [`2019-speaker-deck-cookie-monster-your-browsers.md`](2019-speaker-deck-cookie-monster-your-browsers.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
...
Rethinking How to Build and Grow SRE Teams / Rethinking SRE #1: Building and Growing SRE Teams
...
AI-Driven Development Moves from Individual Skill to Team Effort: Practical Design for Organizations to Make Full Use of AI
...
[CEDEC2026] Expand “Relink” — CI Operations That Protect Development Speed and Quality for “GRANBLUE FANTASY: Relink - Endless Ragnarok”
...
What We Can Do to Protect Cloud Environments from Software Supply Chain Attacks
...
Does an Old-Fogey Forensic Investigator Dream of AI Sheep?
...
Introduction to Cloud Security: Basic Knowledge for Safe Cloud Use
...
[CEDEC2026] Workforce Development Strategy Undertaken by a Highly Specialized Deformation Team — From Planning to Implementation of Cygames Academia
...
OSPN.JPProgress Report on the Version Upgrade Work / 20260801-osc26kyoto
...
What We Did to Run a Data Platform Used by 70% of the Company with a Two-Person Data Team
...
Introduction to TypeScript 2026
...
Product Security Exercises for the AI Era: Learning Through Attack and Defense
