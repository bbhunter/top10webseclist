...
tags: [article, webseclist-reference, en, claroty]
generated:
...
cited_by:
  - "2022.md:23"
commit: ""
content_sha256: 96c5788332d39cce87eda1082ffedf398ee5039c25cfd2d013103856fd7dd71c
depth: full
depth_reason: default
kind: article
language: en
licence: unknown
original_url: "https://claroty.com/team82/research/js-on-security-off-abusing-json-based-sql-to-bypass-waf"
published: 2022-12-08
publisher: Claroty
publisher_english: ""
raw_sha256: 015019553546efeb6ad537b18009ea141c345ac2b703457c7d005705f576c036
retrieved_from: "https://claroty.com/team82/research/js-on-security-off-abusing-json-based-sql-to-bypass-waf"
retrieved_kind: live
retrieved_utc: "2026-08-10T15:07:15+00:00"
slug: 2022-claroty-js-security-off-abusing-json-based-sql-bypass-waf
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
- Preserved from: https://claroty.com/team82/research/js-on-security-off-abusing-json-based-sql-to-bypass-waf (live) on 2026-08-10
- Licence: unknown
...
# {JS-ON: Security-OFF}: Abusing JSON-Based SQL to Bypass WAF
 ...
 ![{JS-ON: Security-OFF}: Abusing JSON-Based SQL to Bypass WAF](https://claroty.com/img/asset/YXNzZXRzL2NsYXJvdHktYmxvZy1ncmFwaGljc18xMi0yMi0wMS5wbmc/claroty-blog-graphics_12-22-01.png?fm=webp&fit=crop&w=800&h=450&s=b494f94408196f53e118cf59f86e0742)
...
Our journey to developing this technique began last year during unrelated research on Cambium Networks’ wireless device management platform, including its cnMaestro wireless network manager that is sold either on-premises or in the cloud.
 ...
 ![cnmaestro](https://claroty.com/img/asset/YXNzZXRzL2NubWFlc3Ryby0xNjcwNTE2OTgxLnBuZw/cnmaestro-1670516981.png?fm=webp&fit=crop&s=594771dda26b7d2b7b99b4c011f09471)  **

*A Cambium Networks wireless access point. *

 ![cnMaestro workflow](https://claroty.com/img/asset/YXNzZXRzL2NsYXJvdHktYmxvZy1ncmFwaGljc18xMi0yMi0wMi5wbmc/claroty-blog-graphics_12-22-02.png?fm=webp&fit=crop&s=4e791607e6842675a91d0d1baa7795ab)  **
...
The core issue of this vulnerability was that in this particular case, the developers did not use a prepared statement to append user-supplied data to a query. Instead of using a safe method of appending user parameters into an SQL query and sanitizing the input, they simply appended it to the query directly.
 ...
 ![waf sink point](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zaW5rLXBvaW50LTE2NzA1MjA3NzMucG5n/waf_sink-point-1670520773.png?fm=webp&fit=crop&s=dab2413eee0ddfb4d2bfffac15e53936)  **
...
This limitation was easily overcome by casting any string we want to exfiltrate into an integer array, returning each character as a separate row. To do so, we used the `stringtoarray` and `ASCII` SQL functions.
 ...
 ![waf select ascii](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zZWxlY3Rhc2NpaS0xNjcwNTIwODQxLnBuZw/waf_selectascii-1670520841.png?fm=webp&fit=crop&s=2b389ed66c46956af081692eef4455b7)  **

 ![waf test](https://claroty.com/img/asset/YXNzZXRzL3dhZl90ZXN0YXNjaWkucG5n/waf_testascii.png?fm=webp&fit=crop&s=1f34046a0fe156e0cebf1a8ce13a5993)  **
...
We managed to overcome this limitation by appending the row index, which translates the index of the character in the string to the returned integer, using the `row_number` SQL function. Because we only return ASCII characters, each character value is limited to 128. By adding the index number multiplied by a thousand (`i * 1000`) and appending it to the result, we can always be sure of the character index using a simple division and module actions.
 ...
 ![waf select ascii](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zZWxlY3RjLTE2NzA1MjA5NTEucG5n/waf_selectc-1670520951.png?fm=webp&fit=crop&s=916d14492b3c74ab8d0220bef21b1b6f)  **

 ![waf test index](https://claroty.com/img/asset/YXNzZXRzL3dhZl90ZXN0aW5kZXgyLTE2Njk5MjAyOTAucG5n/waf_testindex2-1669920290.png?fm=webp&fit=crop&s=bae325c920dbc3853e191a95ca9c23b7)  **
...
Our solution was actually very elegant: instead of returning one row for each character, we would instead construct an integer out of many rows. This is possible because of the difference in byte size between integers and characters. In PostgreSQL, an integer is 4 bytes long, while the character we try to exfiltrate is up to 1 byte long (as long as we are talking about ascii characters). This means that by performing simple byte operations, we can house four different characters in each integer. Furthermore, if we cast our integer into a `BIGINT` in our union command, which is possible to do in PostgreSQL, we can expand each row into 8 bytes.
 ...
 ![waf numeric types](https://claroty.com/img/asset/YXNzZXRzL3dhZl9udW1lcmljLXR5cGVzLnBuZw/waf_numeric-types.png?fm=webp&fit=crop&s=1c2738fdc5069ca2c258ff7c520fd2f3)  **
...
This means that if we were to append 8 bytes for each character we exfiltrate, and append it into a `BIGINT`, we could exfiltrate 7 times more characters in each request (1 byte is reserved to the character index).
 ...
 ![waf select id](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zZWxlY3RpZC0xNjcwNTIxMTI2LnBuZw/waf_selectid-1670521126.png?fm=webp&fit=crop&s=a9fa457b6016b3f3d13079e2491c2de2)  **

 ![waf testsss](https://claroty.com/img/asset/YXNzZXRzL3dhZl90ZXN0c3NzLnBuZw/waf_testsss.png?fm=webp&fit=crop&s=53bdea3a0e8515e2cb100dfca7eda410)  **
...
After we bypassed all three limitations, we were left with a big payload allowing us to extract any data we chose:
 ...
 ![waf evasion](https://claroty.com/img/asset/YXNzZXRzL2NsYXJvdHktYmxvZy1ncmFwaGljc18xMi0yMi0wNC5wbmc/claroty-blog-graphics_12-22-04.png?fm=webp&fit=crop&s=7a764b24879c14029500c618cc82b796)  **
...
And indeed, when we used this payload we managed to exfiltrate sensitive information stored in the database ranging from session cookies to tokens, SSH keys and hashed passwords.
 ...
 ![waf cookie](https://claroty.com/img/asset/YXNzZXRzL3dhZl9jb29raWUucG5n/waf_cookie.png?fm=webp&fit=crop&s=6cabe0c57f546f09531207dc38d1e4b5)  **
...
After managing to fully exploit this vulnerability on the on-prem version, our next step was to try the same vulnerability on Cambium’s cloud. Soon enough we found the corresponding cloud route, and we managed to confirm it is vulnerable to the same vulnerability. We then tried a safe version of our payload, and we received this response:
 ...
 ![waf 403](https://claroty.com/img/asset/YXNzZXRzL3dhZl80MDMtZm9yYmlkZGVuLnBuZw/waf_403-forbidden.png?fm=webp&fit=crop&s=0aa8830751f943350946926ef9a775cf)  **
...
In order to research the AWS WAF, we first created our own setup where we control all moving parts: the application, the client and the WAF settings and logs. We created a simple machine on the AWS cloud, and set up the AWS WAF to protect the application from malicious requests (we set up the WAF).
 ...
 ![waf addsql](https://claroty.com/img/asset/YXNzZXRzL3dhZl9hZGRzcWwucG5n/waf_addsql.png?fm=webp&fit=crop&s=88ae6e4ab3f3a63535c94e43dfbc77b1)  **
...
Then, we created a web application with a SQLi vulnerability, and hosted it on AWS.
 ...
 ![waf vulnapp](https://claroty.com/img/asset/YXNzZXRzL3dhZl92dWxuYXBwLTE2NzA1MjExNjkucG5n/waf_vulnapp-1670521169.png?fm=webp&fit=crop&s=fa964fe61228b7bd9ce5e7fb74e4810d)  **
...
Lastly, we started sending hundreds of specially crafted requests to try and analyze how the WAF flags requests as malicious.
 ...
 ![waf malicious SQL](https://claroty.com/img/asset/YXNzZXRzL3dhZl9tYWxzcWxpcGF5bG9hZC0xNjcwNTIxMjAxLnBuZw/waf_malsqlipayload-1670521201.png?fm=webp&fit=crop&s=f10b314f77547b861e5de1dde0efb7fa)  **
...
By using JSON in SQL, an application can fetch data, combine multiple sources from within the database, perform data modification and transform it to JSON format—all within the SQL API. Then, the application can receive the JSON-formatted data and work with it immediately, without processing the data as well.
 ...
 ![waf input table](https://claroty.com/img/asset/YXNzZXRzL3dhZl9pbnB1dHRhYmxlLnBuZw/waf_inputtable.png?fm=webp&fit=crop&s=2814011d2b63c9394fea5bd4188759dd)  **
...
While each database chose a different implementation and JSON parser, each supports a different range of JSON functions and operators. Also, they all support the JSON data type and basic JSON searches and modifications.
 ...
 ![{JS-ON: Security-OFF}: Abusing JSON-Based SQL to Bypass WAF](https://claroty.com/img/asset/YXNzZXRzL2NsYXJvdHktYmxvZy1ncmFwaGljc18xMi0yMi0wMS5wbmc/claroty-blog-graphics_12-22-01.png?fm=webp&fit=crop&s=4296eb124eaef7aa05b4c36a9c5618f7)  **
...
As it turns out, JSON was exactly this mismatch between the WAF’s parser and the database engine. When we passed valid SQL statements that used less prevalent JSON syntax, the WAF actually did not flag the request as malicious.
 ...
 ![waf sqlbypass](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zcWxpYnlwYXNzLTE2NzA1MjEyMzkucG5n/waf_sqlibypass-1670521239.png?fm=webp&fit=crop&s=992901a4aa197461ef2bd201f2d5652c)  **
...
This simple JSON operator, `@>` in this case, which checks whether the right JSON is contained in the left one, above, threw the WAF into a loop and allowed us to supply malicious SQLi payloads, allowing us to bypass the WAF. By simply prepending simple JSON syntax to the start of the request, we were able to exfiltrate sensitive information using our SQLi vulnerability over the cloud!
 ...
 ![waf expolit](https://claroty.com/img/asset/YXNzZXRzL3dhZl9leHBsb2l0LnBuZw/waf_exploit.png?fm=webp&fit=crop&s=d96c855e8eafba43144f6805ba009925)  **
...
Imperva
 ...
 ![waf vendors](https://claroty.com/img/asset/YXNzZXRzL3dhZl92ZW5kb3JzLnBuZw/waf_vendors.png?fm=webp&fit=crop&s=38a1f12db18b030cd5282698ecd26d89)  **
...
In order to showcase how big this WAF bypass is, we decided to add support for JSON syntax evasion techniques to the biggest open-source exploitation tool, [SQLMap](https://github.com/sqlmapproject/sqlmap).
 ...
 ![waf sql map](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zcWxtYXAucG5n/waf_sqlmap.png?fm=webp&fit=crop&s=a36e6b67ee4c6d4c4c9530e031a25e19)  **
...
While SQLMap offers some WAF evasion techniques, we found that it is still easily identified by most modern WAFs, meaning that users cannot use it in cases where a WAF is present.
 ...
 ![waf sql map bypass](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zcWxtYXBieXBhc3MtMTY3MDUxODE3MS5wbmc/waf_sqlmapbypass-1670518171.png?fm=webp&fit=crop&s=10d94389c2ddf3e8d658ce85b0292651)  **

*Trying to execute SQLMap on an application protected by a WAF. We can clearly see that even though the application is vulnerable, SQLMap does not deem it exploitable since most requests are dropped by the WAF.*
...
Our goal was to bring this new technique into SQLMap, and to use JSON syntax in order to bypass WAFs. In order to do so, we injected payloads generated by SQLMap, adding randomly generated JSON syntax. Since every database engine implemented a different set of JSON functions and operators, we implemented a separate script for each database engine. Using our addition to SQLMap, we were able to bypass a well-known WAF and successfully exploit a vulnerable web application.
 ...
 ![waf evasion](https://claroty.com/img/asset/YXNzZXRzL3dhZl9ldmFzaW9uLnBuZw/waf_evasion.png?fm=webp&fit=crop&s=b042c559f6e57e213418533bf5f1dfa6)  **
...
Team82 disclosed its findings to five of the leading WAF vendors, all of which have added JSON syntax support to their products. We believe that other vendors’ products may be affected, and that reviews for JSON support should be carried out. Below are Amazon’s and F5’s acknowledgements and fixes, for example.
 ...
 ![waf aws](https://claroty.com/img/asset/YXNzZXRzL3dhZl9hd3MtMTY3MDUyMTI4NS5wbmc/waf_aws-1670521285.png?fm=webp&fit=crop&s=8c6a3c5dff33573eea7f8c206fc2ea69)  **
...
*AWS release notes for the Amazon AWS ELB ruleset, adding support for JSON syntax in SQLi inspection and blocking this bypass.*
 ...
 ![waf f5](https://claroty.com/img/asset/YXNzZXRzL3dhZl9mNS5wbmc/waf_f5.png?fm=webp&fit=crop&s=2ac72b40acac8ca4a5b2832b36953f89)  **
...
CVSS v3: 8.1
  ...
  ** Close Modal  ![cnmaestro](https://claroty.com/img/asset/YXNzZXRzL2NubWFlc3Ryby0xNjcwNTE2OTgxLnBuZw/cnmaestro-1670516981.png?fm=webp&fit=crop&s=594771dda26b7d2b7b99b4c011f09471)

  ** Close Modal  ![cnMaestro workflow](https://claroty.com/img/asset/YXNzZXRzL2NsYXJvdHktYmxvZy1ncmFwaGljc18xMi0yMi0wMi5wbmc/claroty-blog-graphics_12-22-02.png?fm=webp&fit=crop&s=4e791607e6842675a91d0d1baa7795ab)

  ** Close Modal  ![waf sink point](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zaW5rLXBvaW50LTE2NzA1MjA3NzMucG5n/waf_sink-point-1670520773.png?fm=webp&fit=crop&s=dab2413eee0ddfb4d2bfffac15e53936)

  ** Close Modal  ![waf select ascii](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zZWxlY3Rhc2NpaS0xNjcwNTIwODQxLnBuZw/waf_selectascii-1670520841.png?fm=webp&fit=crop&s=2b389ed66c46956af081692eef4455b7)

  ** Close Modal  ![waf test](https://claroty.com/img/asset/YXNzZXRzL3dhZl90ZXN0YXNjaWkucG5n/waf_testascii.png?fm=webp&fit=crop&s=1f34046a0fe156e0cebf1a8ce13a5993)

  ** Close Modal  ![waf select ascii](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zZWxlY3RjLTE2NzA1MjA5NTEucG5n/waf_selectc-1670520951.png?fm=webp&fit=crop&s=916d14492b3c74ab8d0220bef21b1b6f)

  ** Close Modal  ![waf test index](https://claroty.com/img/asset/YXNzZXRzL3dhZl90ZXN0aW5kZXgyLTE2Njk5MjAyOTAucG5n/waf_testindex2-1669920290.png?fm=webp&fit=crop&s=bae325c920dbc3853e191a95ca9c23b7)

  ** Close Modal  ![waf numeric types](https://claroty.com/img/asset/YXNzZXRzL3dhZl9udW1lcmljLXR5cGVzLnBuZw/waf_numeric-types.png?fm=webp&fit=crop&s=1c2738fdc5069ca2c258ff7c520fd2f3)

  ** Close Modal  ![waf select id](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zZWxlY3RpZC0xNjcwNTIxMTI2LnBuZw/waf_selectid-1670521126.png?fm=webp&fit=crop&s=a9fa457b6016b3f3d13079e2491c2de2)

  ** Close Modal  ![waf testsss](https://claroty.com/img/asset/YXNzZXRzL3dhZl90ZXN0c3NzLnBuZw/waf_testsss.png?fm=webp&fit=crop&s=53bdea3a0e8515e2cb100dfca7eda410)

  ** Close Modal  ![waf evasion](https://claroty.com/img/asset/YXNzZXRzL2NsYXJvdHktYmxvZy1ncmFwaGljc18xMi0yMi0wNC5wbmc/claroty-blog-graphics_12-22-04.png?fm=webp&fit=crop&s=7a764b24879c14029500c618cc82b796)

  ** Close Modal  ![waf cookie](https://claroty.com/img/asset/YXNzZXRzL3dhZl9jb29raWUucG5n/waf_cookie.png?fm=webp&fit=crop&s=6cabe0c57f546f09531207dc38d1e4b5)

  ** Close Modal  ![waf 403](https://claroty.com/img/asset/YXNzZXRzL3dhZl80MDMtZm9yYmlkZGVuLnBuZw/waf_403-forbidden.png?fm=webp&fit=crop&s=0aa8830751f943350946926ef9a775cf)

  ** Close Modal  ![waf addsql](https://claroty.com/img/asset/YXNzZXRzL3dhZl9hZGRzcWwucG5n/waf_addsql.png?fm=webp&fit=crop&s=88ae6e4ab3f3a63535c94e43dfbc77b1)

  ** Close Modal  ![waf vulnapp](https://claroty.com/img/asset/YXNzZXRzL3dhZl92dWxuYXBwLTE2NzA1MjExNjkucG5n/waf_vulnapp-1670521169.png?fm=webp&fit=crop&s=fa964fe61228b7bd9ce5e7fb74e4810d)

  ** Close Modal  ![waf malicious SQL](https://claroty.com/img/asset/YXNzZXRzL3dhZl9tYWxzcWxpcGF5bG9hZC0xNjcwNTIxMjAxLnBuZw/waf_malsqlipayload-1670521201.png?fm=webp&fit=crop&s=f10b314f77547b861e5de1dde0efb7fa)

  ** Close Modal  ![waf input table](https://claroty.com/img/asset/YXNzZXRzL3dhZl9pbnB1dHRhYmxlLnBuZw/waf_inputtable.png?fm=webp&fit=crop&s=2814011d2b63c9394fea5bd4188759dd)

  ** Close Modal  ![{JS-ON: Security-OFF}: Abusing JSON-Based SQL to Bypass WAF](https://claroty.com/img/asset/YXNzZXRzL2NsYXJvdHktYmxvZy1ncmFwaGljc18xMi0yMi0wMS5wbmc/claroty-blog-graphics_12-22-01.png?fm=webp&fit=crop&s=4296eb124eaef7aa05b4c36a9c5618f7)

  ** Close Modal  ![waf sqlbypass](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zcWxpYnlwYXNzLTE2NzA1MjEyMzkucG5n/waf_sqlibypass-1670521239.png?fm=webp&fit=crop&s=992901a4aa197461ef2bd201f2d5652c)

  ** Close Modal  ![waf expolit](https://claroty.com/img/asset/YXNzZXRzL3dhZl9leHBsb2l0LnBuZw/waf_exploit.png?fm=webp&fit=crop&s=d96c855e8eafba43144f6805ba009925)

  ** Close Modal  ![waf vendors](https://claroty.com/img/asset/YXNzZXRzL3dhZl92ZW5kb3JzLnBuZw/waf_vendors.png?fm=webp&fit=crop&s=38a1f12db18b030cd5282698ecd26d89)

  ** Close Modal  ![waf sql map](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zcWxtYXAucG5n/waf_sqlmap.png?fm=webp&fit=crop&s=a36e6b67ee4c6d4c4c9530e031a25e19)

  ** Close Modal  ![waf sql map bypass](https://claroty.com/img/asset/YXNzZXRzL3dhZl9zcWxtYXBieXBhc3MtMTY3MDUxODE3MS5wbmc/waf_sqlmapbypass-1670518171.png?fm=webp&fit=crop&s=10d94389c2ddf3e8d658ce85b0292651)

  ** Close Modal  ![waf evasion](https://claroty.com/img/asset/YXNzZXRzL3dhZl9ldmFzaW9uLnBuZw/waf_evasion.png?fm=webp&fit=crop&s=b042c559f6e57e213418533bf5f1dfa6)

  ** Close Modal  ![waf aws](https://claroty.com/img/asset/YXNzZXRzL3dhZl9hd3MtMTY3MDUyMTI4NS5wbmc/waf_aws-1670521285.png?fm=webp&fit=crop&s=8c6a3c5dff33573eea7f8c206fc2ea69)

  ** Close Modal  ![waf f5](https://claroty.com/img/asset/YXNzZXRzL3dhZl9mNS5wbmc/waf_f5.png?fm=webp&fit=crop&s=2ac72b40acac8ca4a5b2832b36953f89)
