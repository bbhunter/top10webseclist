...
cited_by:
  - "2022.md:31"
commit: ""
content_sha256: 3b3df7e37bb7ce49d337d7c88a8549ce9d3ecccfe985e949ad440ecc96deca9e
depth: full
depth_reason: default
kind: article
language: fr
licence: unknown
original_url: "https://www.synacktiv.com/publications/persistent-php-payloads-in-pngs-how-to-inject-php-code-in-an-image-and-keep-it-there.html"
published: ""
publisher: Synacktiv
publisher_english: ""
raw_sha256: 09a147b64d4d645346b46408bfed4142b3016c3cbc86153d506b3f81e846c10a
retrieved_from: "https://www.synacktiv.com/publications/persistent-php-payloads-in-pngs-how-to-inject-php-code-in-an-image-and-keep-it-there.html"
retrieved_kind: live
retrieved_utc: "2026-08-09T01:45:22+00:00"
slug: synacktiv-persistent-php-payloads-pngs-how-inject-php-code-image_translate
snapshot: ""
title_english: ""
translation_file: ""
translation_of: synacktiv-persistent-php-payloads-pngs-how-inject-php-code-image.md
---

# Persistent PHP payloads in PNGs: How to inject PHP code in an image – (English translation)

**Persistent PHP payloads in PNGs: How to inject PHP code in an image –** - @Synacktiv, Synacktiv.

- Published: date not stated
- Original: <https://www.synacktiv.com/publications/persistent-php-payloads-in-pngs-how-to-inject-php-code-in-an-image-and-keep-it-there.html>
- Preserved from: https://www.synacktiv.com/publications/persistent-php-payloads-in-pngs-how-to-inject-php-code-in-an-image-and-keep-it-there.html (live) on 2026-08-09
- Licence: unknown
...
_Machine translation of [`synacktiv-persistent-php-payloads-pngs-how-inject-php-code-image.md`](synacktiv-persistent-php-payloads-pngs-how-inject-php-code-image.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
...
Written by Quentin Roland - 10/10/2022 - in Pentest - [Download](https://www.synacktiv.com/publications/persistent-php-payloads-in-pngs-how-to-inject-php-code-in-an-image-and-keep-it-there)
...
Want to improve your skills? Discover our **training** sessions! [Learn more](https://www.synacktiv.com/offres/formations)
...
*src\Controller\HomeController.php – public function firstPart*
...
`http://localhost:8000/suits_thumbnails/633d51fa76f2c_nasa.png`
 ...
 ![Legitimate file upload to the application.](https://www.synacktiv.com/sites/default/files/inline-images/2.webp)

*A legitimate file upload to the application.*
...
![PNG comments - payload executed](https://www.synacktiv.com/sites/default/files/inline-images/3_0.webp)

*PHP payload executed through PNG comments.*

######

#### [Method No. 2] Raw insertion.
...
Even with our PHP payload inserted at the end, the MIME type of the file is still considered as being `image/png`. Since the file is uploaded to the web server *as-is*, without any further processing, the trailing PHP payload will remain in the file. It will then be executed by the server in the same way as for the first method shown above.

### **2. Defeating PHP-GD image compression**

Most of the time however, image files are not stored *as-is *on the server, as was assumed in the first part of the article. Images are resized, compressed or encoded into specific file formats using some standard PHP libraries like [PHP-GD](https://www.php.net/manual/fr/book.image.php).
...
*src\Controller\HomeController.php – public function secondPart*
...
*payloads/generators/**generate_**plte**_png.php*
...
![PHP payload execution through PLTE chunk.](https://www.synacktiv.com/sites/default/files/inline-images/4.webp)

*PHP payload executed through PLTE chunk.*
...
*src\Controller\HomeController.php – public function thirdPart*
...
![Execution of PHP payload through IDAT chunk.](https://www.synacktiv.com/sites/default/files/inline-images/5.webp)

*PHP payload executed through IDAT chunk.*
...
*src\Controller\HomeController.php – public function fourthPart*
...
As we can see, the PNG comments we used for [Method n°1] are nothing more than a special predefined type of tEXt chunk.
...
*payloads/generators/**generate_**tEXt**_png.php*
...
![PHP payload executed through tEXt chunk.](https://www.synacktiv.com/sites/default/files/inline-images/6.webp)

*PHP payload executed through tEXt chunk.*
