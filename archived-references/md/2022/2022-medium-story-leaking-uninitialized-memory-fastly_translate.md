...
slug: 2022-medium-story-leaking-uninitialized-memory-fastly_translate
snapshot: ""
title_english: ""
translation_file: ""
translation_of: 2022-medium-story-leaking-uninitialized-memory-fastly.md
---

# A story of leaking uninitialized memory from Fastly (English translation)
...
_Machine translation of [`2022-medium-story-leaking-uninitialized-memory-fastly.md`](2022-medium-story-leaking-uninitialized-memory-fastly.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
...
– after processing the frame with the receiving 30000th byte of the body, it enlarges the `stream->recvbuf` to the size 30000 and writes the last byte of it, leaving the rest uninitialized. It also sets the `eos` value to 30000 as the FIN flag is set in the frame;
