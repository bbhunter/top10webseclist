...
cs.CR
  ...
  [< prev](https://arxiv.org/prevnext?id=2205.10174&function=prev&context=cs.CR)   |   [next >](https://arxiv.org/prevnext?id=2205.10174&function=next&context=cs.CR)

 [new](https://arxiv.org/list/cs.CR/new)  |  [recent](https://arxiv.org/list/cs.CR/recent)  | [2022-05](https://arxiv.org/list/cs.CR/2022-05)

 Change to browse by:

 [cs](https://arxiv.org/abs/2205.10174?context=cs)

### References & Citations

- [NASA ADS](https://ui.adsabs.harvard.edu/abs/arXiv:2205.10174)
- [Google Scholar](https://scholar.google.com/scholar_lookup?arxiv_id=2205.10174)
- [Semantic Scholar](https://api.semanticscholar.org/arXiv:2205.10174)

 export BibTeX citation

### Bookmark

[ ![BibSonomy](https://arxiv.org/static/browse/0.3.4/images/icons/social/bibsonomy.png) ](http://www.bibsonomy.org/BibtexHandler?requTask=upload&url=https://arxiv.org/abs/2205.10174&description=Pre-hijacked accounts: An Empirical Study of Security Failures in User Account Creation on the Web) [ ![Reddit](https://arxiv.org/static/browse/0.3.4/images/icons/social/reddit.png) ](https://reddit.com/submit?url=https://arxiv.org/abs/2205.10174&title=Pre-hijacked accounts: An Empirical Study of Security Failures in User Account Creation on the Web)
