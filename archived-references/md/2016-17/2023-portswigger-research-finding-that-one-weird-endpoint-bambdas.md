---
type: Article
title: Finding that one weird endpoint, with Bambdas
description: Shows how small Burp Suite Bambdas can analyze saved HTTP traffic for unusual endpoint behavior. Examples cover response inconsistencies, content-type problems and overlooked API endpoints, illustrating how rapid local filtering can support exploratory security research.
resource: "https://portswigger.net/research/finding-that-one-weird-endpoint-with-bambdas"
tags: [article, webseclist-reference, portswigger, tooling, detection, http, content-type, graphql, csp, owasp-a05-2021, owasp-a09-2021]
generated:
  by: webseclist-refs/1
  at: "2026-09-16T13:46:31+00:00"
status: stable
...
sources:
  - id: original
    resource: "https://portswigger.net/research/finding-that-one-weird-endpoint-with-bambdas"
    title: Finding that one weird endpoint, with Bambdas
    author: James Kettle, Gareth Heyes
...
cited_by:
  - "2016-17.md:22"
commit: ""
content_sha256: 93e8bad972cbd979698e7adf4dae7a68710670867e73f25f97417fabb6b95705
depth: full
depth_reason: default
kind: article
language: ""
licence: unknown
original_url: "https://portswigger.net/research/finding-that-one-weird-endpoint-with-bambdas"
published: 2023-12-12
publisher: PortSwigger
publisher_english: ""
raw_sha256: e69e63efc1dd7a48670dcbf8733a08db0215b45145ec79ea01afb1a72d05933a
retrieved_from: "https://portswigger.net/research/finding-that-one-weird-endpoint-with-bambdas"
retrieved_kind: live
retrieved_utc: "2026-09-16T13:46:31+00:00"
slug: 2023-portswigger-research-finding-that-one-weird-endpoint-bambdas
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
**Finding that one weird endpoint, with Bambdas** - James Kettle, Gareth Heyes, PortSwigger.

- Published: 2023-12-12
- Original: <https://portswigger.net/research/finding-that-one-weird-endpoint-with-bambdas>
- Preserved from: https://portswigger.net/research/finding-that-one-weird-endpoint-with-bambdas (live) on 2026-09-16
- Licence: unknown
...
Finding that one weird endpoint, with Bambdas | PortSwigger Research
...
`int realContentLength = requestResponse.response().body().length(); int declaredContentLength = Integer.parseInt(
 requestResponse.response().headerValue("Content-Length")); return declaredContentLength != realContentLength; `
