...
title_english: ""
translation_file: ""
translation_of: agrrrdog-blogspot-com-autobinding-vulns-spring-mvc.md
---
...
_Machine translation of [`agrrrdog-blogspot-com-autobinding-vulns-spring-mvc.md`](agrrrdog-blogspot-com-autobinding-vulns-spring-mvc.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
