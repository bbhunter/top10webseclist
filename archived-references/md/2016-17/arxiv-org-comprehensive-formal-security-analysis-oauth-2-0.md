...
cited_by:
  - "2016-17.md:72"
commit: ""
content_sha256: 31cb51f3c735f08345315642af0d2a9043a57c50f4b9ce35e79cc0f2b972b218
depth: full
...
- Preserved from: https://arxiv.org/abs/1601.01229 (live) on 2026-08-08
- Licence: unknown
...
cs.CR
  ...
  [< prev](https://arxiv.org/prevnext?id=1601.01229&function=prev&context=cs.CR)   |   [next >](https://arxiv.org/prevnext?id=1601.01229&function=next&context=cs.CR)

 [new](https://arxiv.org/list/cs.CR/new)  |  [recent](https://arxiv.org/list/cs.CR/recent)  | [2016-01](https://arxiv.org/list/cs.CR/2016-01)

 Change to browse by:

 [cs](https://arxiv.org/abs/1601.01229?context=cs)

### References & Citations

- [NASA ADS](https://ui.adsabs.harvard.edu/abs/arXiv:1601.01229)
- [Google Scholar](https://scholar.google.com/scholar_lookup?arxiv_id=1601.01229)
- [Semantic Scholar](https://api.semanticscholar.org/arXiv:1601.01229)

### [DBLP](https://dblp.uni-trier.de) - CS Bibliography

 [listing](https://dblp.uni-trier.de/db/journals/corr/corr1601.html#FettKS16) | [bibtex](https://dblp.uni-trier.de/rec/bibtex/journals/corr/FettKS16)

 [Daniel Fett](https://dblp.uni-trier.de/search/author?author=Daniel%20Fett)
[Ralf Küsters](https://dblp.uni-trier.de/search/author?author=Ralf%20K%C3%BCsters)
[Guido Schmitz](https://dblp.uni-trier.de/search/author?author=Guido%20Schmitz)

 export BibTeX citation

### Bookmark

[ ![BibSonomy](https://arxiv.org/static/browse/0.3.4/images/icons/social/bibsonomy.png) ](http://www.bibsonomy.org/BibtexHandler?requTask=upload&url=https://arxiv.org/abs/1601.01229&description=A Comprehensive Formal Security Analysis of OAuth 2.0) [ ![Reddit](https://arxiv.org/static/browse/0.3.4/images/icons/social/reddit.png) ](https://reddit.com/submit?url=https://arxiv.org/abs/1601.01229&title=A Comprehensive Formal Security Analysis of OAuth 2.0)
