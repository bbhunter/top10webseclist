...
slug: 2020-speaker-deck-revisiting-redos-rough-idea-data-exfiltration-techniques_translate
snapshot: ""
title_english: ""
translation_file: ""
translation_of: 2020-speaker-deck-revisiting-redos-rough-idea-data-exfiltration-techniques.md
---

# Revisiting ReDoS: A Rough Idea of Data Exfiltration by ReDoS and Side-channel Techniques (English translation)
...
_Machine translation of [`2020-speaker-deck-revisiting-redos-rough-idea-data-exfiltration-techniques.md`](2020-speaker-deck-revisiting-redos-rough-idea-data-exfiltration-techniques.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
...
Creating a “Common Language” for Product Security — Using Technical Education and Policy as Code as Examples / "Language" for Product Security
...
Mastering Security Engineering with SRE / SRE, Security Engineering, and You
...
The Future of the Software Supply Chain / Securing Software Supply Chain
...
Accelerating AWS Security Management with Policy as Code — Toward the Best CSPM Experience / Unleashing Policy as Code on AWS CSPM
...
Practical SpiceDB — Toward Implementing Permission Management That Can Survive the Cloud-Native Era / Practical SpiceDB
...
The Concept of Developer-First Security / Introduction to Developer-First Security
...
Let's Build a Small Web Browser (Online Lecture Version) / Build Your Own Web Browser
...
Let's Build “Guardrails” for Writing Secure Go / Let's Build Security Guardrails For Your Go Programs!
...
Computational Informatics Laboratory (Mathematical Informatics Laboratory No. 7) 2026
...
The Work of a Research Engineer / Research Engineering: Bridging Research and Business
...
GLIM and MegaParticles: The Limits of Gaussian Approximation and Advances in Tight Coupling & Particle Filters / GLIM and MegaParticles : Progress of the distribution representation in SLAM
...
Proposal and Demonstration of a Joint AS Operation Model Toward Establishing Autonomous IPv6 Connectivity at the Laboratory Level
...
Nationwide Town/Aza-Level Vacant House Rate Estimation Data ver1.0 Specifications
...
[CV Study Group @ Kanto CVPR2026] PSDesigner: Automated Graphic Design with a Human-Like Creative Workflow / kantocv 67th CVPR 2026
...
Discussion: What Does It Take to Make an Academic Movement Successful?
...
How Much of SLAM Has Been Solved?
...
What Awaits Us in a World Where AI Writes 90% of the Code? / What awaits us in a world where 90% of the code is written by AI
