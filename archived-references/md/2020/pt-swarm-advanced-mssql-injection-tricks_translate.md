...
slug: pt-swarm-advanced-mssql-injection-tricks_translate
snapshot: ""
title_english: ""
translation_file: ""
translation_of: pt-swarm-advanced-mssql-injection-tricks.md
---

# Advanced MSSQL Injection Tricks (English translation)
...
_Machine translation of [`pt-swarm-advanced-mssql-injection-tricks.md`](pt-swarm-advanced-mssql-injection-tricks.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
...
Non-standard whitespace characters: %C2%85 or %C2%A0:
