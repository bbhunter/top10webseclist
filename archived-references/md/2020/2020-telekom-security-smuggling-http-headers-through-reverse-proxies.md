...
tags: [article, webseclist-reference, en, telekom-security, header-injection, parser-differential, auth-bypass, smuggling, reverse-proxy, proxy, http, python, php, mitigation, owasp-a01-2021, owasp-a03-2021]
generated:
...
cited_by:
  - "2020.md:10"
commit: ""
content_sha256: 0227c7321dfc3a5c2b57fa47d0a6b1d5c857413aca4884a896431bb19ea98939
depth: full
depth_reason: default
kind: article
language: en
licence: unknown
original_url: "https://github.security.telekom.com/2020/05/smuggling-http-headers-through-reverse-proxies.html"
published: 2020-05-15
publisher: Telekom Security
publisher_english: ""
raw_sha256: 1de26c834be9eb38dd8bde5f725ec0b9dba4c2b4ed128a89277ea3dc45d748ac
retrieved_from: "https://github.security.telekom.com/2020/05/smuggling-http-headers-through-reverse-proxies.html"
retrieved_kind: live
retrieved_utc: "2026-08-09T01:13:42+00:00"
slug: 2020-telekom-security-smuggling-http-headers-through-reverse-proxies
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
1) A reverse proxy in front of the backend does the mutual TLS (mTLS) flow and ensures a valid client certificate. 2) Some X509 fields like an email address or a full name are extracted from the certificate. 3) The fields are added as additional headers and the request is forwarded to the backend. 4) The backend authenticates the user (by the passed fields).
