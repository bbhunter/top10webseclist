...
cited_by:
  - "2020.md:13"
commit: ""
content_sha256: baf59e73415cd62616a81816f32456f98ed31a1cd606dfd322fcc7fa15678d61
depth: full
depth_reason: default
kind: article
language: en-US
licence: unknown
original_url: "https://swarm.ptsecurity.com/attacking-ms-exchange-web-interfaces/"
published: ""
publisher: PT SWARM
publisher_english: ""
raw_sha256: 71b01f1a3b34caa3a0f8c94a62927750fd0afd1b02f1a9e8828b1870b6730dd8
retrieved_from: "https://swarm.ptsecurity.com/attacking-ms-exchange-web-interfaces/"
retrieved_kind: stored
retrieved_utc: "2026-08-09T10:26:28+00:00"
slug: pt-swarm-attacking-ms-exchange-web-interfaces
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
**Attacking MS Exchange Web Interfaces** - Arseniy Sharoglazov, @_mohemiv, PT SWARM.

- Published: date not stated
- Original: <https://swarm.ptsecurity.com/attacking-ms-exchange-web-interfaces/>
- Preserved from: https://swarm.ptsecurity.com/attacking-ms-exchange-web-interfaces/ (stored) on 2026-08-09
- Licence: unknown
...
If you had been a black hat, you would try to sign into the Exchange and access the user’s mailbox. However, for red teamers, it’s never possible since keeping the client data private is the main goal during penetration testing engagements.
...
Exchange servers have a url */autodiscover/autodiscover.xml* that implements [Autodiscover Publishing and Lookup Protocol (MS-OXDSCLI)](https://docs.microsoft.com/en-us/openspecs/exchange_server_protocols/ms-oxdscli/78530279-d042-4eb0-a1f4-03b18143cd19). It accepts special requests that return a configuration of the mailbox to which an email belongs.
...
There are ways to get Address Lists without touching OABs (e.g., [via MAPI over HTTP in Ruler](https://github.com/sensepost/ruler/wiki/GAL) or [via OWA or EWS in MailSniper](https://github.com/dafthack/MailSniper)), but these techniques require your account to have a mailbox associated with it.

After getting a user list, you can perform a Password Spraying attack via the same Autodiscover service or via any other domain authentication on the perimeter. I advise you check out [ntlmscan utility](https://github.com/nyxgeek/ntlmscan), as it contains a quite good wordlist of NTLM endpoints.
...
Link to a technique: [https://www.mdsec.co.uk/2019/01/abusing-office-web-add-ins-for-fun-and-limited-profit/](https://www.mdsec.co.uk/2019/01/abusing-office-web-add-ins-for-fun-and-limited-profit/)
...
The structure of RPC over HTTP v2 data is described [in the MS-RPCH Specification](https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-rpch/c0f4c9c5-1a61-4d10-b8e2-005378d1d212), and it just consists of ordinary MSRPC packets and special RTS RPC packets, where RTS stands for Request to Send.
...
For more information about RpcProxyShim.dll and RPC Proxy ACLs, read comments [in our MS-RPCH implimentation code](https://github.com/SecureAuthCorp/impacket/blob/b97fdef3daafc2a3b736cfe4cfe5712d81f1be96/impacket/dcerpc/v5/rpch.py#L477).
...
```
$ rpcmap.py -debug -auth-transport 'CONTOSO/mia:P@ssw0rd' -auth-rpc 'CONTOSO/mia:P@ssw0rd' -auth-level 6 -brute-opnums 'ncacn_http:[6001,RpcProxy=exch01.contoso.com:443]'
...
The rpcmap.py works via the Remote Management Interface described [in MS-RPCE 2.2.1.3](https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-rpce/3165f378-ede3-48a8-b871-be1183e1b7fb). If it’s available, it can show all interfaces offered by the RPC Server. Note that the tool may show non-available endpoints, and provider and protocol lines are taken from the Impacket database, and they can be wrong.
...
| [MS‑OXCRPC](https://docs.microsoft.com/en-us/openspecs/exchange_server_protocols/ms-oxcrpc/137f0ce2-31fd-4952-8a7d-6c0b242e4b6a) | A4F1DB00-CA47-1067-B31F-00DD010662DA v0.81 | Wire Format Protocol EMSMDB Interface |  |
| [MS‑OXCRPC](https://docs.microsoft.com/en-us/openspecs/exchange_server_protocols/ms-oxcrpc/137f0ce2-31fd-4952-8a7d-6c0b242e4b6a) | 5261574A-4572-206E-B268-6B199213B4E4 v0.1 | Wire Format Protocol AsyncEMSMDB Interface |  |
| [MS‑OXABREF](https://docs.microsoft.com/en-us/openspecs/exchange_server_protocols/ms-oxabref/88c2b896-fe4f-4e28-8a87-e83a73d9c90e) | 1544F5E0-613C-11D1-93DF-00C04FD7BD09 v1.0 | Address Book Name Service Provider Interface (NSPI) Referral Protocol |  |
| [MS‑OXNSPI](https://docs.microsoft.com/en-us/openspecs/exchange_server_protocols/ms-oxnspi/63662a26-c8fc-4493-a41a-fbcbb7e43136) | F5CC5A18-4264-101A-8C59-08002B2F8426 v56.0 | Exchange Server Name Service Provider Interface (NSPI) Protocol |  |
...
The exchanger.py tool, and rpcmap.py and rpcdump.py utilities are now avaliable in the official Impacket repository: [https://github.com/SecureAuthCorp/impacket](https://github.com/SecureAuthCorp/impacket)

Thanks [@agsolino](https://twitter.com/agsolino) for merging!
...
Feel free to comment on this article [on our Twitter](https://twitter.com/ptswarm/status/1286300883744165890). Follow [@ptswarm](https://twitter.com/ptswarm) or [@_mohemiv](https://twitter.com/_mohemiv) so you don’t miss our future research and other publications.
