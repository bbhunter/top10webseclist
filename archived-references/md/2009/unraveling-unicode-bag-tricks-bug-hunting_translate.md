...
slug: unraveling-unicode-bag-tricks-bug-hunting_translate
snapshot: ""
title_english: ""
translation_file: ""
translation_of: unraveling-unicode-bag-tricks-bug-hunting.md
---

# Unraveling Unicode: A Bag of Tricks for Bug Hunting (English translation)
...
_Machine translation of [`unraveling-unicode-bag-tricks-bug-hunting.md`](unraveling-unicode-bag-tricks-bug-hunting.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
