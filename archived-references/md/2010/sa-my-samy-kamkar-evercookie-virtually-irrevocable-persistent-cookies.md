...
tags: [article, webseclist-reference, sa-my, cookie, javascript, tooling, flash, java, info-leak, side-channel, cache, owasp-a07-2021]
generated:
  by: webseclist-refs/1
  at: "2026-09-10T00:57:58+00:00"
status: stable
...
cited_by:
  - "2010.md:6"
commit: ""
content_sha256: 7c7974f51d5c73705ce914c4625505ab8ad9b6513058a06f1abce865c770e4b6
depth: full
...
retrieved_from: "http://samy.pl/evercookie/"
retrieved_kind: manual-import
retrieved_utc: "2026-09-10T00:57:58+00:00"
...
```html
<input onclick="document.getElementById('idtag').innerHTML = '*creating*'; document.getElementById('cookies').innerHTML = ''; ec.set('uid', val); setTimeout(getC, 1000, 1); " type="button" value="Click to create an evercookie"/>
```

Now, try deleting this "uid" cookie anywhere possible, then

```html
<input onclick="document.getElementById('idtag').innerHTML = '*checking*'; document.getElementById('cookies').innerHTML = ''; setTimeout(getC, 300);" type="button" value="Click to rediscover cookies"/>
```

or

```html
<input onclick="document.getElementById('idtag').innerHTML = '*checking*'; document.getElementById('cookies').innerHTML = ''; setTimeout(getC, 300, 1);" type="button" value="Click to rediscover cookies WITHOUT reactivating deleted cookies"/>
```
