...
tags: [whitepaper, webseclist-reference, clickjacking, ui-redress, xss, csrf, https, cache-poisoning, info-leak, attack-chain, owasp-a01-2021, owasp-a02-2021, owasp-a03-2021, owasp-a04-2021]
generated:
  by: webseclist-refs/1
  at: "2026-09-09T22:47:03+00:00"
status: stable
...
cited_by:
  ...
  - "2010.md:51"
commit: ""
content_sha256: 15a907ed0987c2b0fe88074e05f80672ccdb921087f66fafb5b6d405f7273555
depth: full
...
retrieved_utc: "2026-09-09T22:47:03+00:00"
slug: bad-memories
snapshot: ""
title_english: ""
translation_file: ""
...
- Preserved from: https://media.blackhat.com/bh-us-10/whitepapers/Bursztein_Gourdin_Rydstedt/BlackHat-USA-2010-Bursztein-Bad-Memories-wp.pdf (manual-import) on 2026-09-09
- Licence: unknown
...
Bad memories summarize our latest research results on offensive web technologies. The Secu-
...
```mermaid
flowchart LR
V["Victim"] -->|"1 Fetch the malicious page"| A["Attacker"]
V -->|"2 Fingerprint the browser"| V
V -->|"3 Find the router"| R["Router"]
V -->|"4 Fingerprint the router"| R
V -->|"5 Inject the payload"| R
R -->|"6 Extract the data"| A
A -->|"7 Geolocalize the network using the location aware browsing protocol"| G["Google"]
```
...
![Figure 2: Our router attacking tool](../../figures/2010/bad-memories/figure-02.png)
...
In this section we demonstrate how an attacker can compromise multiple HTTPS sessions by
...
![Figure 3: Chrome SSL warning](../../figures/2010/bad-memories/figure-03.png)
...
![Figure 4: Internet Explorer 8 standard SSL warning](../../figures/2010/bad-memories/figure-04.png)
...
![Figure 5: Internet Explorer 8 corner case](../../figures/2010/bad-memories/figure-05.png)
...
![Figure 6: Firefox standard SSL warning](../../figures/2010/bad-memories/figure-06.png)
...
![Figure 7: Firefox standard SSL warning Framed](../../figures/2010/bad-memories/figure-07.png)

Figure 7: Firefox standard SSL warning Framed

<!-- Original PDF page 17 -->

![Figure 8: Firefox: Remaining popup after the clickjacking attack warning](../../figures/2010/bad-memories/figure-08.png)

Figure 8: Firefox: Remaining popup after the clickjacking attack warning

<!-- Original PDF page 18 -->

## 4 Attacking Facebook with Frame leak attack
...
![Figure 9: Facebook clickjacking Black Div defense](../../figures/2010/bad-memories/figure-09.png)
...
![Figure 10: Facebook frame leak attack tool](../../figures/2010/bad-memories/figure-10.png)
...
In this section we introduce TapJacking attacks, a clickjacking attack that leverages the accessi-
...
![Figure 11: Tapjacking Twitter with a zoomed button](../../figures/2010/bad-memories/figure-11.png)

Figure 11: Tapjacking Twitter with a zoomed button

<!-- Original PDF page 22 -->

![Figure 12: Faking the URL bar](../../figures/2010/bad-memories/figure-12.png)
...
Niu et al. [10] previously used the iPhone’s browser scrolling mechanism to design a phishing
...
In this paper we demonstrated that attackers can make secure communication protocols irrel-
