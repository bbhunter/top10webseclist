...
tags: [article, webseclist-reference, en, samuli-hakoniemi-net]
generated:
...
cited_by:
  - "2010.md:70"
commit: ""
content_sha256: 47a9c04828170bdd12a6e34d46fc56aa7757ce0923611f0f7672886036ed55d0
depth: full
...
publisher_english: ""
raw_sha256: dc2e3a4f258de162b9ddbd147a8d76e25a2ade04323b36a4f26fa72334b7125a
retrieved_from: "https://web.archive.org/web/20101224204903/http://samuli.hakoniemi.net/how-to-conceal-xss-injection-in-html5/"
retrieved_kind: live
retrieved_utc: "2026-08-09T01:39:44+00:00"
slug: samuli-hakoniemi-net-http-samuli-hakoniemi-net-how-conceal-xss-injection-html5
snapshot: 20101224204903
title_english: ""
translation_file: ""
translation_of: ""
---
...
**How to Conceal XSS Injection in HTML5** - Author not stated, samuli.hakoniemi.net.

- Published: date not stated
- Original: <https://web.archive.org/web/20101224204903/http://samuli.hakoniemi.net/how-to-conceal-xss-injection-in-html5/>
- Preserved from: https://web.archive.org/web/20101224204903/http://samuli.hakoniemi.net/how-to-conceal-xss-injection-in-html5/ (live) on 2026-08-09
- Capture timestamp: 20101224204903
- Licence: unknown
...
[history.pushState()](https://web.archive.org/web/20101224204903/https://developer.mozilla.org/en/DOM/Manipulating_the_browser_history#The_pushState().c2.a0method) was introduced in HTML5 and it’s meant for modifying history entries.
...
As you can see the URL is pretty ugly. Therefore shortened it in a trusted URL shortener service (like everyone does nowadays): [http://bit.ly/pushStateXSS](https://web.archive.org/web/20101224204903/http://bit.ly/pushStateXSS).
...
**Note:** I’m taking advantage of this technique in my [//bit.ly/xss_1](https://web.archive.org/web/20101224204903/http://bit.ly/xss_1), which I use for pointing out the XSS vulnerabilities for website administrators. It just removes everything after “?” from the URL in address bar.

Tags: [history.pushstate](https://web.archive.org/web/20101224204903/http://samuli.hakoniemi.net/tag/history-pushstate/), [html5](https://web.archive.org/web/20101224204903/http://samuli.hakoniemi.net/tag/html5/), [javascript](https://web.archive.org/web/20101224204903/http://samuli.hakoniemi.net/tag/javascript/), [security](https://web.archive.org/web/20101224204903/http://samuli.hakoniemi.net/tag/security/), [xss](https://web.archive.org/web/20101224204903/http://samuli.hakoniemi.net/tag/xss/)
