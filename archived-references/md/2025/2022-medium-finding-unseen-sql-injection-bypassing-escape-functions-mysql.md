...
cited_by:
  - "2025.md:26"
commit: ""
content_sha256: 63bd59f6911f934d17996a8a5cd4e6122cb22848fba69a98a31182e0bd62e4dc
depth: full
depth_reason: default
kind: article
language: en
licence: unknown
original_url: "https://flattsecurity.medium.com/finding-an-unseen-sql-injection-by-bypassing-escape-functions-in-mysqljs-mysql-90b27f6542b4"
published: 2022-05-23
publisher: Medium
publisher_english: ""
raw_sha256: f30736f649a9c12406840078bc8c4db7cecd6fe1aecfdf4a605153622b247628
retrieved_from: "https://flattsecurity.medium.com/finding-an-unseen-sql-injection-by-bypassing-escape-functions-in-mysqljs-mysql-90b27f6542b4"
retrieved_kind: stored
retrieved_utc: "2026-08-09T10:08:20+00:00"
slug: 2022-medium-finding-unseen-sql-injection-bypassing-escape-functions-mysql
snapshot: 20250622215541
title_english: ""
translation_file: ""
translation_of: ""
---
...
It was found that unexpected behaviors in the query’s escape function could cause a SQL injection in `mysqljs/mysql` ([https://github.com/mysqljs/mysql](https://github.com/mysqljs/mysql)), which is one of the most popular MySQL packages in the Node.js ecosystem.
...
- [https://blog.sqreen.com/preventing-sql-injection-in-node-js-and-other-vulnerabilities/](https://blog.sqreen.com/preventing-sql-injection-in-node-js-and-other-vulnerabilities/)
- [https://www.veracode.com/blog/secure-development/how-prevent-sql-injection-nodejs](https://www.veracode.com/blog/secure-development/how-prevent-sql-injection-nodejs)
- [https://www.stackhawk.com/blog/node-js-sql-injection-guide-examples-and-prevention/](https://www.stackhawk.com/blog/node-js-sql-injection-guide-examples-and-prevention/)

**Tutorials**

- [https://codeshack.io/basic-login-system-nodejs-express-mysql/](https://codeshack.io/basic-login-system-nodejs-express-mysql/)
- [https://www.tutsmake.com/node-js-express-login-example-with-mysql/](https://www.tutsmake.com/node-js-express-login-example-with-mysql/)
- [https://www.nicesnippets.com/blog/nodejs-express-login-with-mysql-example](https://www.nicesnippets.com/blog/nodejs-express-login-with-mysql-example)

# Exploit Demonstration

The vulnerable sample project we will use throughout this article is referenced from the top-most tutorial on a Google Search. ([https://codeshack.io/basic-login-system-nodejs-express-mysql/](https://codeshack.io/basic-login-system-nodejs-express-mysql/))

For your convenience, I wrote a `docker-compose.yml`, and you may be able to run this code quickly on your machine. [https://github.com/stypr/vulnerable-nodejs-express-mysql](https://github.com/stypr/vulnerable-nodejs-express-mysql)

I also created a sample live instance so you can also access [https://sqli.blog-demo.flatt.training/](https://sqli.blog-demo.flatt.training/) for testing purposes.
...
[https://github.com/mysqljs/mysql/blob/master/Readme.md#escaping-query-values](https://github.com/mysqljs/mysql/blob/master/Readme.md#escaping-query-values)
...
The function`escape` is loaded from `mysqljs/sqlstring`([https://github.com/mysqljs/sqlstring](https://github.com/mysqljs/sqlstring)), and from here we see that escaping is done differently based on the type of the value.
...
Flatt Security Inc. provides security assessment services. We are willing to have offers from overseas. If you have any question, please contact us by [https://flatt.tech/en/](https://flatt.tech/en/.).

Thank you for reading this article.

# Thanks

I would like to thank @SANGWOO and [@sangwhanmoon](https://twitter.com/sangwhanmoon) for sharing good advice and feedback on this blog post. Thanks to my co-workers for reviewing and reading my post!
