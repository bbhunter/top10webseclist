...
tags: [article, webseclist-reference, en, the-trail-of-bits-blog, parser-differential, mass-assignment, auth-bypass, privilege-escalation, go, static-analysis, mitigation, cve, owasp-a01-2021]
generated:
...
cited_by:
  - "2025.md:22"
commit: ""
content_sha256: 74410473181752f712f68499344b2eea30c774d864986d2fe8027fb07e162f16
depth: full
...
publisher_english: ""
raw_sha256: 8d443ab8d4f11d21ea2f9d6d1accebb768e7e2856791f2ac5f9a3428b1ba9c82
retrieved_from: "https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/"
retrieved_kind: live
retrieved_utc: "2026-08-09T01:07:12+00:00"
slug: 2025-the-trail-of-bits-blog-unexpected-security-footguns-go-s-parsers
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
![Parsing JSON in Go](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/json_parsing_hu_67fe65a7606e22fe.webp)
...
![Parsing JSON in Go with NewDecoder](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/json_parsing_2_hu_744a76adafcc04dd.webp)
...
![Shows an interaction with a backend server in which the user can set the IsAdmin field of the User struct, which should not be possible](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/create_user_hu_2cfa29f65706e0b8.webp)

Similarly, when fetching the user, you may not want the user to return the user’s `Password` or other secret values.

![Shows an interaction with a backend server in which the user can get the Password field of the User struct, which should not be possible](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/get_user_hu_deed5bbd22b84331.webp)
...
![Image showing how to unmarshal a field with a tag of “-,…” in JSON, XML, and YAML](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/tag_with_dash_hu_39d2c1ddeb1a57ac.webp)
...
![Shows an interaction with a backend server in which the user can set the IsAdmin field with the - JSON field name](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/create_user_2_hu_c1f1870cfb864737.webp)
...
![Image showing the system described above with a flow in which the user successfully authenticates](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/parser_diff_success_hu_278bd1b84f7b936c.webp)

In this second flow, the same regular user attempts to perform an `AdminAction`, an action they are **forbidden** to perform.

![Image showing the system described above with a flow in which the user fails to authenticate](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/parser_diff_fail_hu_37d0edb4a29d13a8.webp)

Finally, the following flow is because the services disagree on the action the user is trying to perform.

![Image showing the system described above with a vulnerable flow in which Proxy and Authorization services disagree when parsing an action from the user input.](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/parser_diff_attack_hu_d81c2a93d1f87f.webp)
...
![Image showing the attack scenario with the exploit described above](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/parser_diff_duplicate_fields_hu_1fad9113ac6019d8.webp)
...
![Image summarizing the behavior for all three parsers](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/parser_diff_duplicate_fields_summary_hu_f7e137649dcdec01.webp)
...
![Image showing the attack scenario with the exploit described above](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/parser_diff_case_insensitivity_1_hu_cc372c2e2e852be0.webp)
...
![Image summarizing the behavior for all three parsers](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/parser_diff_case_insensitivity_summary_hu_fb0681d4b99e007c.webp)
...
- An AWS resource (e.g., an AWS Lambda function) presigns a [GetCallerIdentity](https://docs.aws.amazon.com/STS/latest/APIReference/API_GetCallerIdentity.html) request.
...
![Image showing the Vault authentication flow](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/data_format_confusion_1_hu_d610484b7be70a78.webp)
...
![Image showing the Vault authentication flow with the exploit described above](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/data_format_confusion_2_hu_b7ab46e8e5d27d93.webp)
...
![Summary of the behavior of the JSON, XML, and YAML parsers for unknown keys](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/unknown_keys_1_hu_986aef489472a4d6.webp)

### Leading garbage data

Of the three parsers, only the XML parser accepts leading garbage data.

![Summary of the behavior of the JSON, XML, and YAML parsers for leading garbage data](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/leading_garbage_data_1_hu_36a85af312c6b9a4.webp)

### Trailing garbage data

Again, only the XML parser accepts arbitrary trailing garbage data.

![Summary of the behavior of the JSON, XML, and YAML parsers for trailing garbage data](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/trailing_garbage_data_1_hu_8233892dbbc90b3.webp)
...
![Summary of the behavior of the JSON, XML, and YAML parsers for trailing garbage data with the Decoder API](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/trailing_garbage_data_2_hu_7628dc3272b0cf86.webp)
...
![Image showing the polyglot above and which parsers parse which value as explained below](https://blog.trailofbits.com/2025/06/17/unexpected-security-footguns-in-gos-parsers/polyglot_hu_7cc086d22a09ff9c.webp)
...
**Watch for JSON v2**. Keep an eye on the development of Go’s [JSON v2](https://github.com/golang/go/issues/71497) library, which addresses many of these issues with safer defaults for JSON.
