...
description: Studies how distinct EDNS Client Subnet values prevent DNS query aggregation while replies omitting that option create additional spoofed-response matches. Controlled resolver experiments and deployment measurements examine poisoning opportunities, configuration requirements and limits; Internet measurements identify prerequisites rather than confirmed poisoned services.
resource: "https://lixiang521.com/publication/ccs25/ccs2025-rebirthday-li.pdf"
tags: [whitepaper, webseclist-reference, acm, dns, cache-poisoning, measurement-study, parser-differential]
generated:
  by: webseclist-refs/1
  at: "2026-09-13T22:10:13+00:00"
verified:
...
cited_by:
  - "2025.md:116"
commit: ""
content_sha256: 97bdf7dec543f5c2baae030ae67cc7fb82392653cca433bcf35b7cb945b757f2
depth: full
depth_reason: default
kind: whitepaper
language: ""
licence: unknown
original_url: "https://lixiang521.com/publication/ccs25/ccs2025-rebirthday-li.pdf"
published: ""
publisher: ACM
publisher_english: ""
raw_sha256: aa23ee8b6f118432652c574f5018f851da5b559720b573ad3c4bdaeddb59426d
retrieved_from: "https://lixiang521.com/publication/ccs25/ccs2025-rebirthday-li.pdf"
retrieved_kind: live
retrieved_utc: "2026-09-13T22:10:13+00:00"
slug: acm-rebirthday-attack-reviving-dns-cache-poisoning-birthday-paradox-2
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
**RebirthDay Attack: Reviving DNS Cache Poisoning with the Birthday Paradox** - Xiang Li, Mingming Zhang, Zuyao Xu, Fasheng Miao, Yuqi Qiu, Baojun Liu, Jia Zhang, Xiaofeng Zheng, Haixin Duan, Zheli Liu, Yunhai Zhang, Dunqiu Fan, ACM.

- Published: date not stated
- Original: <https://lixiang521.com/publication/ccs25/ccs2025-rebirthday-li.pdf>
- Preserved from: https://lixiang521.com/publication/ccs25/ccs2025-rebirthday-li.pdf (live) on 2026-09-13
- Licence: unknown
...
† Also with QI-ANXIN Technology Research Institute.                                             Xiang Li, Mingming Zhang, Zuyao Xu, Fasheng Miao, Yuqi Qiu, Baojun
...
for profit or commercial advantage and that copies bear this notice and the full citation       13–17, 2025, Taipei, China. ACM, New York, NY, USA, 15 pages. https:
on the first page. Copyrights for components of this work owned by others than the
author(s) must be honored. Abstracting with credit is permitted. To copy otherwise, or
                                                                                                //doi.org/10.1145/3719027.3744832
republish, to post on servers or to redistribute to lists, requires prior specific permission
and/or a fee. Request permissions from permissions@acm.org.
CCS ’25, Taipei, China                                                                          1   Introduction
© 2025 Copyright held by the owner/author(s). Publication rights licensed to ACM.
ACM ISBN 979-8-4007-1525-9/2025/10                                                              The Domain Name System (DNS) provides translation between
https://doi.org/10.1145/3719027.3744832                                                         human-readable domain names and machine-readable IP addresses.
CCS ’25, October 13–17, 2025, Taipei, China                                                                                         Xiang Li et al.
...
RebirthDay Attack                                                                                                                                                                                                     CCS ’25, October 13–17, 2025, Taipei, China
...
attack, which exploits vulnerabilities in bailiwick checking algo-
                                                                                             Query * Q
rithms to perform DNS cache poisoning. This attack targets DNS                                  ...                  Identical Queries    Query * 1
...
4.1.3 Software Implementations. We summarize the implementa-              these implementations verify the presence of a cache entry asso-
