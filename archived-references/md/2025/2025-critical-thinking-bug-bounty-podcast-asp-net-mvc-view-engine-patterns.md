...
cited_by:
  - "2025.md:40"
commit: ""
content_sha256: fc71c8e619e1856636fb97025f9a6320698368a056b4bb18c1a4db9bc9c61104
depth: full
depth_reason: default
kind: article
language: en
licence: unknown
original_url: "https://lab.ctbb.show/research/asp-net-mvc-view-engine-search-patterns"
published: 2025-11-17
publisher: Critical Thinking - Bug Bounty Podcast
publisher_english: ""
raw_sha256: 882fc7c6a912708e572f88a57535bf631fd4e17f831a18267f2a67d9178471a9
retrieved_from: "https://lab.ctbb.show/research/asp-net-mvc-view-engine-search-patterns"
retrieved_kind: live
retrieved_utc: "2026-08-09T01:32:56+00:00"
slug: 2025-critical-thinking-bug-bounty-podcast-asp-net-mvc-view-engine-patterns
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
**ASP.NET MVC View Engine Search Patterns** - Diyan Apostolov, Critical Thinking - Bug Bounty Podcast.

- Published: 2025-11-17
- Original: <https://lab.ctbb.show/research/asp-net-mvc-view-engine-search-patterns>
- Preserved from: https://lab.ctbb.show/research/asp-net-mvc-view-engine-search-patterns (live) on 2026-08-09
- Licence: unknown
...
~/authors/fsi — profile
 ...
 ![fsi avatar](https://lab.ctbb.show/assets/images/fsi.jpg)

 fsi Diyan Apostolov

   Nov 17, 2025

RCE thoughts by Diyan Apostolov
...
- ASP.NET MVC’s UrlRoutingModule intercepts it
- Routes are matched against patterns in RouteConfig.cs (typically {controller}/{action}/{id})
- Framework extracts controller name, action name, and parameters
- Controller class is instantiated via ControllerFactory
...
- The Details action method executes
- Business logic runs (database queries, calculations, etc.)
- Method returns an ActionResult (typically ViewResult)
- If return View() is called → **View Resolution Process Begins**
...
! Note: When you call /Controller/Method, and trace it (via procmon for example) you see these file access attempts:

>

[!example] Process Monitor Output Process: w3wp.exe Operation: CreateFile
...
**Result**: Remote Code Execution View Engine can access ANY FILE on the file system, regardless of extension whitelist!
