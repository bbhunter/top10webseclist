...
[!](https://web.archive.org/web/20190820211223/https://www.whitehatsec.com/wp-content/uploads/jeremiah11.jpeg)[X-Frame-Options](https://web.archive.org/web/20190820211223/http://blogs.msdn.com/b/ieinternals/archive/2010/03/30/combating-clickjacking-with-x-frame-options.aspx) (XFO) is an HTTP response header, mostly used to combat [Clickjacking](https://web.archive.org/web/20190820211223/http://en.wikipedia.org/wiki/Clickjacking), that informs a Web browser if the page should be rendered in a <* frame> or <* iframe>. “X-Frame-Options: deny” means that the browser should never allow the page to be framed. “X-Frame-Options: sameorigin” means only the hosting domain is allowed to frame the page. In either case, a third-party website is never allowed to frame the page. No frames, no Clickjacking.
