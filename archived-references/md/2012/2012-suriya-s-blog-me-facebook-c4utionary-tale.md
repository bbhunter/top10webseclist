...
Pingback: [Facebook's phone search can be abused to find people's numbers, researchers say | 投资手机](http://pczn.info/facebooks-phone-search-can-be-abused-to-find-peoples-numbers-researchers-say.html)
...
Pingback: [Phone Numbers Revealed | 投资手机](http://pczn.info/phone-numbers-revealed.html)
...
Pingback: [Facebook phone number lookups now limited, but you should still tweak this privacy setting | 投资手机](http://pczn.info/facebook-phone-number-lookups-now-limited-but-you-should-still-tweak-this-privacy-setting.html)
...
Pingback: [【注意】Facebookに大量の電話番号を取得できるセキュリティーホール発覚 - でじつべ](http://dgtube.net/sns/12970/)
