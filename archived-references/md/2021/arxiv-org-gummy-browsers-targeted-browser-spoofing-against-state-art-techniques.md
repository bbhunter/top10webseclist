...
cs.CR
  ...
  [< prev](https://arxiv.org/prevnext?id=2110.10129&function=prev&context=cs.CR)   |   [next >](https://arxiv.org/prevnext?id=2110.10129&function=next&context=cs.CR)

 [new](https://arxiv.org/list/cs.CR/new)  |  [recent](https://arxiv.org/list/cs.CR/recent)  | [2021-10](https://arxiv.org/list/cs.CR/2021-10)

 Change to browse by:

 [cs](https://arxiv.org/abs/2110.10129?context=cs)

### References & Citations

- [NASA ADS](https://ui.adsabs.harvard.edu/abs/arXiv:2110.10129)
- [Google Scholar](https://scholar.google.com/scholar_lookup?arxiv_id=2110.10129)
- [Semantic Scholar](https://api.semanticscholar.org/arXiv:2110.10129)

### [DBLP](https://dblp.uni-trier.de) - CS Bibliography

 [listing](https://dblp.uni-trier.de/db/journals/corr/corr2110.html#abs-2110-10129) | [bibtex](https://dblp.uni-trier.de/rec/bibtex/journals/corr/abs-2110-10129)

 [Prakash Shrestha](https://dblp.uni-trier.de/search/author?author=Prakash%20Shrestha)
[Nitesh Saxena](https://dblp.uni-trier.de/search/author?author=Nitesh%20Saxena)

 export BibTeX citation

### Bookmark

[ ![BibSonomy](https://arxiv.org/static/browse/0.3.4/images/icons/social/bibsonomy.png) ](http://www.bibsonomy.org/BibtexHandler?requTask=upload&url=https://arxiv.org/abs/2110.10129&description=Gummy Browsers: Targeted Browser Spoofing against State-of-the-Art Fingerprinting Techniques) [ ![Reddit](https://arxiv.org/static/browse/0.3.4/images/icons/social/reddit.png) ](https://reddit.com/submit?url=https://arxiv.org/abs/2110.10129&title=Gummy Browsers: Targeted Browser Spoofing against State-of-the-Art Fingerprinting Techniques)
