...
slug: 2021-blog-ryotak-net-remote-code-execution-homebrew-compromising-repository_translate
snapshot: ""
title_english: ""
translation_file: ""
translation_of: 2021-blog-ryotak-net-remote-code-execution-homebrew-compromising-repository.md
---

# Remote code execution in Homebrew by compromising the official Cask repository (English translation)
...
_Machine translation of [`2021-blog-ryotak-net-remote-code-execution-homebrew-compromising-repository.md`](2021-blog-ryotak-net-remote-code-execution-homebrew-compromising-repository.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
...
This article has also been published in Japanese: [https://blog.ryotak.net/post/homebrew-security-incident/](https://blog.ryotak.net/post/homebrew-security-incident/)
(If you can read Japanese, the author recommends reading the Japanese article because they are not very proficient in English.)
