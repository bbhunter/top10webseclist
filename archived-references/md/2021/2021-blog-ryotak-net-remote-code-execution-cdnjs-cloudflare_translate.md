...
slug: 2021-blog-ryotak-net-remote-code-execution-cdnjs-cloudflare_translate
snapshot: ""
title_english: ""
translation_file: ""
translation_of: 2021-blog-ryotak-net-remote-code-execution-cdnjs-cloudflare.md
---

# Remote code execution in cdnjs of Cloudflare (English translation)
...
_Machine translation of [`2021-blog-ryotak-net-remote-code-execution-cdnjs-cloudflare.md`](2021-blog-ryotak-net-remote-code-execution-cdnjs-cloudflare.md), which holds the source's own words. Code, payloads, type names, URLs and CVE identifiers were masked before translating and restored after, so they are byte-identical to the original._
...
([Japanese version](https://blog.ryotak.net/post/cdnjs-remote-code-execution) is also available.)
