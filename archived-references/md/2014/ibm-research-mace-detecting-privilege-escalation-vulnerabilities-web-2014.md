...
**MACE: Detecting privilege escalation vulnerabilities in web applications for CCS 2014** - @IBMResearch, IBM Research.
...
### [Reconciling end-to-end confidentiality and data reduction in cloud storage ](https://research.ibm.com/publications/reconciling-end-to-end-confidentiality-and-data-reduction-in-cloud-storage)

Nathalie Baracaldo, Elli Androulaki, et al.

CCS 2014

Conference paper

### [Integrity, consistency, and verification of remote computation ](https://research.ibm.com/publications/integrity-consistency-and-verification-of-remote-computation)
...
### [Primal infon logic: Derivability in polynomial time ](https://research.ibm.com/publications/primal-infon-logic-derivability-in-polynomial-time)

Anguraj Baskar, Prasad Naldurg, et al.

FSTTCS 2013

Conference paper

### [Patching logic vulnerabilities for web applications using logicpatcher ](https://research.ibm.com/publications/patching-logic-vulnerabilities-for-web-applications-using-logicpatcher)

Maliheh Monshizadeh, Prasad Naldurg, et al.
