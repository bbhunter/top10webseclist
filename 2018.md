...
-   [SMB hash hijacking & user tracking in MS Outlook](https://soroush.me/downloadable/outlook_smb_hash_hijacking.pdf)
-   [Pride and Prejudice in Progressive Web Apps: Abusing Native App-like Features in Web Applications](https://wsp-lab.github.io/papers/son-ppp-ccs18.pdf) — Jiyeon Lee, Hayeon Kim, Junghwan Park, Insik Shin, Sooel Son
-   [Bypassing Web Cache Poisoning Countermeasures](https://portswigger.net/research/bypassing-web-cache-poisoning-countermeasures) — James Kettle, PortSwigger
