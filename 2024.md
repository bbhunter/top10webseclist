...
> skill, and scored **60 or above** with a qualifying non-duplicate verdict
> before being added. Added 2026-08-09 via the `webseclist-find-missed` skill.

-   [SnailLoad: Exploiting Remote Network Latency Measurements without JavaScript](https://www.usenix.org/conference/usenixsecurity24/presentation/gast) — **judge 90.8/100**, original technique — Stefan Gast et al. (USENIX Security 2024)
-   [Generic and Automated Drive-by GPU Cache Attacks from the Browser](https://www.rolandczerny.com/publications/2024-webgpu/) — **judge 89.7/100**, original technique — Lukas Giner et al. (AsiaCCS 2024)
-   [Web Platform Threats: Automated Detection of Web Security Issues With WPT](https://www.usenix.org/conference/usenixsecurity24/presentation/bernardo) — **judge 89.2/100**, tooling or methodology contribution — Pedro Bernardo et al. (USENIX Security 2024)
-   [CDN Cannon: Exploiting CDN Back-to-Origin Strategies for Amplification Attacks](https://www.usenix.org/conference/usenixsecurity24/presentation/lin-ziyu) — **judge 89.2/100**, original technique — Ziyu Lin et al. (USENIX Security 2024)
-   [GHunter: Universal Prototype Pollution Gadgets in JavaScript Runtimes](https://www.usenix.org/conference/usenixsecurity24/presentation/cornelissen) — **judge 88.5/100**, meaningful extension — Eric Cornelissen, Mikhail Shcherbakov & Musard Balliu (USENIX Security 2024)
-   [Argus: All your (PHP) Injection-sinks are belong to us](https://www.usenix.org/conference/usenixsecurity24/presentation/jahanshahi) — **judge 87.0/100**, tooling or methodology contribution — Rasoul Jahanshahi & Manuel Egele (USENIX Security 2024)
-   [A Flushing Attack on the DNS Cache](https://www.usenix.org/conference/usenixsecurity24/presentation/afek) — **judge 87.0/100**, original technique — Yehuda Afek, Anat Bremler-Barr, Shoham Danino & Yuval Shavitt (USENIX Security 2024)
-   [Pixel Thief: Exploiting SVG Filter Leakage in Firefox and Chrome](https://www.usenix.org/conference/usenixsecurity24/presentation/oconnell) — **judge 86.5/100**, meaningful extension — Sioli O'Connell et al. (USENIX Security 2024)
-   [Internet's Invisible Enemy: Detecting and Measuring Web Cache Poisoning in the Wild](https://doi.org/10.1145/3658644.3690361) — **judge 85.7/100**, meaningful extension — Yuejia Liang et al. (ACM CCS 2024)
-   [Vulnerability-oriented Testing for RESTful APIs](https://www.usenix.org/conference/usenixsecurity24/presentation/du) — **judge 85.0/100**, tooling or methodology contribution — Wenlong Du et al. (USENIX Security 2024)
-   [Peeking through the window: Fingerprinting Browser Extensions through Page-Visible Execution Traces and Interactions](https://doi.org/10.1145/3658644.3670339) — **judge 84.9/100**, original technique — Shubham Agarwal, Aurore Fass & Ben Stock (ACM CCS 2024)
-   [FuzzCache: Optimizing Web Application Fuzzing Through Software-Based Data Cache](https://zhangmx1997.github.io/papers/ccs24_fuzzcache.pdf) — **judge 83.7/100**, tooling or methodology contribution — Penghui Li & Mingxue Zhang (ACM CCS 2024)
-   [ReactAppScan: Mining React Application Vulnerabilities via Component Graph](https://www.yinzhicao.org/reactappscan/reactappscan.pdf) — **judge 83.6/100**, tooling or methodology contribution — Zhiyong Guo et al. (ACM CCS 2024)
-   [AuthSaber: Automated Safety Verification of OpenID Connect Programs](https://ucla-sec-lab.netlify.app/publication/2024-authsaber/) — **judge 82.8/100**, tooling or methodology contribution — Tamjid Al Rahat, Yu Feng & Yuan Tian (ACM CCS 2024)
-   [Spider-Scents: Grey-box Database-aware Web Scanning for Stored XSS](https://www.usenix.org/conference/usenixsecurity24/presentation/olsson) — **judge 82.7/100**, tooling or methodology contribution — Eric Olsson, Benjamin Eriksson, Adam Doupé & Andrei Sabelfeld (USENIX Security 2024)
-   [Rise of Inspectron: Automated Black-box Auditing of Cross-platform Electron Apps](https://www.usenix.org/conference/usenixsecurity24/presentation/ali) — **judge 82.4/100**, tooling or methodology contribution — Mir Masood Ali et al. (USENIX Security 2024)
-   [Arcanum: Detecting and Evaluating the Privacy Risks of Browser Extensions on Web Pages and Web Content](https://www.usenix.org/conference/usenixsecurity24/presentation/xie-qinge) — **judge 79.2/100**, tooling or methodology contribution — Qinge Xie et al. (USENIX Security 2024)
-   [Introducing the URL Validation Bypass Cheat Sheet](https://portswigger.net/research/introducing-the-url-validation-bypass-cheat-sheet) — **judge 78.9/100**, tooling or methodology contribution — Zakhar Fedotkin
-   [Fickle PDFs: exploiting browser rendering discrepancies](https://portswigger.net/research/fickle-pdfs-exploiting-browser-rendering-discrepancies) — **judge 77.1/100**, meaningful combination or adaptation — Zakhar Fedotkin
-   [Concealing payloads in URL credentials](https://portswigger.net/research/concealing-payloads-in-url-credentials) — **judge 76.2/100**, meaningful extension — Gareth Heyes
-   [Introducing SignSaboteur: forge signed web tokens with ease](https://portswigger.net/research/introducing-signsaboteur-forge-signed-web-tokens-with-ease) — **judge 73.0/100**, tooling or methodology contribution — Zakhar Fedotkin
