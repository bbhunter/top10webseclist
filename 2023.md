...
-   [Leaking more than log₂ of the URL count with the selectURL gate](https://github.com/WICG/shared-storage/issues/86) — **judge 69.0/100**, Meaningful extension — anisenoff (Alex Nisenoff)
-   [DOMLeakify: style-attribute ID-existence timing oracle](https://blog.arkark.dev/2023/12/28/seccon-finals) — **judge 63.2/100**, Meaningful combination or adaptation — arkark
