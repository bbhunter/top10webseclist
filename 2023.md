...
> entry. Added 2026-08-07 and reassessed/expanded 2026-08-09 via the
> `webseclist-find-missed` skill.

-   [The Leaky Web: Automated Discovery of Cross-Site Information Leaks in Browsers and the Web](https://trouge.net/papers/xsleaks_sp2023.pdf) — **judge 90.2/100**, tooling or methodology contribution — Jannis Rautenstrauch, Giancarlo Pellegrino & Ben Stock (IEEE S&P 2023)
-   [DiffCSP: Finding Browser Bugs in Content Security Policy Enforcement through Differential Testing](https://www.ndss-symposium.org/ndss-paper/diffcsp-finding-browser-bugs-in-content-security-policy-enforcement-through-differential-testing/) — **judge 89.3/100**, tooling or methodology contribution — Seongil Wi et al. (NDSS 2023)
-   [Isolated and Exhausted: Attacking Operating Systems via Site Isolation in the Browser](https://www.usenix.org/conference/usenixsecurity23/presentation/gierlings) — **judge 87.4/100**, original technique — Matthias Gierlings, Marcus Brinkmann & Jörg Schwenk (USENIX Security 2023)
-   [Scaling JavaScript Abstract Interpretation to Detect and Exploit Node.js Taint-style Vulnerability](https://www.yinzhicao.org/FAST/ODGen-FAST.pdf) — **judge 86.7/100**, tooling or methodology contribution — Mingqing Kang et al. (IEEE S&P 2023)
-   [RøB: Ransomware over Modern Web Browsers](https://www.usenix.org/conference/usenixsecurity23/presentation/oz) — **judge 86.1/100**, original technique — Harun Oz et al. (USENIX Security 2023)
-   [It's (DOM) Clobbering Time: Attack Techniques, Prevalence, and Defenses](https://trouge.net/publication/domclob-sp-2023/) — **judge 85.8/100**, meaningful extension — Soheil Khodayari & Giancarlo Pellegrino (IEEE S&P 2023)
-   [Finding All Cross-Site Needles in the DOM Stack](https://casa.rub.de/en/research/publications/detail/finding-all-cross-site-needles-in-the-dom-stack-a-comprehensive-methodology-for-the-automatic-xs-leak-detection-in-web-browsers) — **judge 85.0/100**, tooling or methodology contribution — Dominik Trevor Noß et al. (ACM CCS 2023)
-   [SynthDB: Synthesizing Database via Program Analysis for Security Testing of Web Applications](https://www.ndss-symposium.org/ndss-paper/synthdb-synthesizing-database-via-program-analysis-for-security-testing-of-web-applications/) — **judge 84.8/100**, tooling or methodology contribution — An Chen et al. (NDSS 2023)
-   [Fashion Faux Pas: Implicit Stylistic Fingerprints for Bypassing Browsers' Anti-Fingerprinting Defenses](https://www.cs.uic.edu/~polakis/papers/lin-sp23.pdf) — **judge 84.5/100**, meaningful extension — Xu Lin et al. (IEEE S&P 2023)
-   [Navigating Murky Waters: Automated Browser Feature Testing for Uncovering Tracking Vectors](https://www.ndss-symposium.org/ndss-paper/navigating-murky-waters-automated-browser-feature-testing-for-uncovering-tracking-vectors/) — **judge 84.5/100**, tooling or methodology contribution — Mir Masood Ali et al. (NDSS 2023)
-   [CoCo: Efficient Browser Extension Vulnerability Detection via Coverage-guided, Concurrent Abstract Interpretation](https://yinzhicao.org/CoCo/CoCo.pdf) — **judge 84.5/100**, tooling or methodology contribution — Jianjia Yu, Song Li, Junmin Zhu & Yinzhi Cao (ACM CCS 2023)
-   [QUICforge: Client-side Request Forgery in QUIC](https://www.ndss-symposium.org/ndss-paper/quicforge-client-side-request-forgery-in-quic/) — **judge 82.9/100**, original technique — Yuri Gbur & Florian Tschorsch (NDSS 2023)
-   [Uncovering and Exploiting Hidden APIs in Mobile Super Apps](https://arxiv.org/abs/2306.08134) — **judge 82.3/100**, tooling or methodology contribution — Chao Wang, Yue Zhang & Zhiqiang Lin (ACM CCS 2023)
-   [Checking Passwords on Leaky Computers: A Side Channel Analysis of Chrome's Password Leak Detect Protocol](https://www.usenix.org/conference/usenixsecurity23/presentation/kwong) — **judge 80.7/100**, meaningful extension — Andrew Kwong et al. (USENIX Security 2023)
-   [A Security Study about Electron Applications and a Programming Methodology to Tame DOM Functionalities](https://www.ndss-symposium.org/ndss-paper/a-security-study-about-electron-applications-and-a-programming-methodology-to-tame-dom-functionalities/) — **judge 80.5/100**, tooling or methodology contribution — Zihao Jin et al. (NDSS 2023)
-   [Extending a Hand to Attackers: Browser Privilege Escalation Attacks via Extensions](https://www.usenix.org/conference/usenixsecurity23/presentation/kim-young-min) — **judge 79.2/100**, tooling or methodology contribution — Young Min Kim & Byoungyoung Lee (USENIX Security 2023)
