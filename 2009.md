...
-   [Creating a rogue CA certificate](http://www.phreedom.org/research/rogue-ca/) **#1**
-   [HTTP Parameter Pollution (HPP)](http://blog.mindedsecurity.com/2009/05/http-parameter-pollution-new-web-attack.html) **#2**
-   [MD5 extension attack](http://netifera.com/research) **#3**
-   [Cross-domain search timing](https://scarybeastsecurity.blogspot.com/2009/12/cross-domain-search-timing.html) **#4**
-   [Slowloris HTTP DoS](http://ha.ckers.org/blog/20090617/slowloris-http-dos/) **#5**
-   [Microsoft IIS with Metasploit evil.asp;.jpg](http://blogs.technet.com/msrc/archive/2009/12/27/new-reports-of-a-vulnerability-in-iis.aspx) **#6**
-   [Exploiting Unexploitable XSS](http://stephensclafani.com/2009/05/26/exploiting-unexploitable-xss/) **#7**
-   [Our Favorite XSS Filters and how to Attack them](https://sirdarckcat.blogspot.com/2009/08/our-favorite-xss-filters-and-how-to.html) **#8**
-   [RFC1918 Caching Security Issues](http://www.sectheory.com/rfc1918-security-issues.htm) **#9**
-   [Persistent Cookies and DNS Rebinding Redux](http://ha.ckers.org/blog/20090120/persistent-cookies-and-dns-rebinding-redux/) **#10**
...
-   [Cross-Site Identification (XSid)](http://blog.quaji.com/2009/12/out-of-context-information-disclosure.html)
...
-   [URL Spoofing vulnerability in bots of search engines](http://www.webappsec.org/lists/websecurity/archive/2009-04/msg00047.html) ([Part 2](http://www.webappsec.org/lists/websecurity/archive/2009-04/msghtml))
...
-   [New Tricks for Defeating SSL in Practice (sslstrip & null-prefix certificates)](https://blackhat.com/presentations/bh-dc-09/Marlinspike/BlackHat-DC-09-Marlinspike-Defeating-SSL.pdf) — **judge 87.3/100**, original technique — Moxie Marlinspike (Black Hat DC 2009)
-   [TLS Renegotiation authentication gap (CVE-2009-3555)](https://www.kb.cert.org/vuls/id/120541/) — **judge 84.4/100**, original technique — Marsh Ray & Steve Dispensa (PhoneFactor)
-   [Pretty-Bad-Proxy: An Overlooked Adversary in Browsers' HTTPS Deployments](https://www.microsoft.com/en-us/research/publication/pretty-bad-proxy-an-overlooked-adversary-in-browsers-https-deployments/) — **judge 84.4/100**, original technique — Shuo Chen, Ziqing Mao, Yi-Min Wang & Ming Zhang (IEEE S&P 2009)
-   [Cross-Origin JavaScript Capability Leaks: Detection, Exploitation, and Defense](https://www.usenix.org/conference/usenixsecurity09/technical-sessions/presentation/cross-origin-javascript-capability-leaks) — **judge 82.4/100**, original technique — Adam Barth, Joel Weinberger & Dawn Song (USENIX Security 2009)
-   [OAuth Security Advisory 2009.1: OAuth 1.0 Request Token Session Fixation](https://oauth.net/advisories/2009-1/) — **judge 80.4/100**, meaningful extension — OAuth community (2009)
-   [Secure Content Sniffing for Web Browsers, or How to Stop Papers from Reviewing Themselves](https://webblaze.cs.berkeley.edu/contentsniff.html) — **judge 79.7/100**, meaningful extension — Adam Barth, Juan Caballero & Dawn Song (IEEE S&P 2009)
-   [Cross-Channel Scripting and Reverse Cross-Channel Scripting](https://www.blackhat.com/presentations/bh-usa-09/BOJINOV/BHUSA09-Bojinov-EmbeddedMgmt-PAPER.pdf) — **judge 78.8/100**, original technique — Hristo Bojinov, Elie Bursztein, Eric Lovett & Dan Boneh (Black Hat USA 2009)
-   [Attacks on JavaScript Mashup Communication](https://www.ieee-security.org/TC/W2SP/2009/papers/s1p3.pdf) — **judge 75.2/100**, meaningful extension — Adam Barth, Collin Jackson & William Li (W2SP 2009)
-   [Code-Injection Attacks in Browsers Supporting Policies (return-to-JavaScript)](https://www.ieee-security.org/TC/W2SP/2009/papers/s3p1.pdf) — **judge 72.9/100**, original technique — Elias Athanasopoulos, Vasilis Pappas & Evangelos P. Markatos (W2SP 2009)
-   [Unraveling Unicode: A Bag of Tricks for Bug Hunting](https://www.blackhat.com/presentations/bh-usa-09/WEBER/BHUSA09-Weber-UnicodeSecurityPreview-SLIDES.pdf) — **judge 70.8/100**, tooling or methodology contribution — Chris Weber (Black Hat USA 2009)
-   [A Wolf in Sheep's Clothing: The Dangers of Persistent Web Browser Storage](https://blackhat.com/presentations/bh-dc-09/Sutton/blackhat-dc-09-Sutton-persistent-storage.pdf) — **judge 63.5/100**, meaningful extension — Michael Sutton (Black Hat DC 2009)
