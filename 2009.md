...
-   [Flickr's API Signature Forgery Vulnerability (MD5 extension attack)](http://netifera.com/research) **#3**
...
-   [Microsoft IIS 0-Day Vulnerability Parsing Files (semi-colon bug)](https://soroush.me/downloadable/iis-semicolon-report.pdf) ([Microsoft advisory](http://blogs.technet.com/msrc/archive/2009/12/27/new-reports-of-a-vulnerability-in-iis.aspx)) **#6**
...
-   DNS Rebinding (3-part series): [Persistent Cookies and DNS Rebinding Redux](http://ha.ckers.org/blog/20090120/persistent-cookies-and-dns-rebinding-redux/), [DNS Rebinding for Scraping and Spamming](http://ha.ckers.org/blog/20091118/dns-rebinding-for-scraping-and-spamming/), [Session Fixation Via DNS Rebinding](http://ha.ckers.org/blog/20091116/session-fixation-via-dns-rebinding/) **#10**
...
> Techniques first published in 2009 that were **not** part of that
> year's original nomination round. They were found and reviewed in a later audit.

-   [New Tricks for Defeating SSL in Practice (sslstrip & null-prefix certificates)](https://blackhat.com/presentations/bh-dc-09/Marlinspike/BlackHat-DC-09-Marlinspike-Defeating-SSL.pdf)
-   [TLS Renegotiation authentication gap (CVE-2009-3555)](https://www.kb.cert.org/vuls/id/120541/)
-   [Pretty-Bad-Proxy: An Overlooked Adversary in Browsers' HTTPS Deployments](https://www.microsoft.com/en-us/research/publication/pretty-bad-proxy-an-overlooked-adversary-in-browsers-https-deployments/)
-   [Cross-Origin JavaScript Capability Leaks: Detection, Exploitation, and Defense](https://www.usenix.org/conference/usenixsecurity09/technical-sessions/presentation/cross-origin-javascript-capability-leaks)
-   [OAuth Security Advisory 2009.1: OAuth 1.0 Request Token Session Fixation](https://oauth.net/advisories/2009-1/)
-   [Secure Content Sniffing for Web Browsers, or How to Stop Papers from Reviewing Themselves](https://webblaze.cs.berkeley.edu/contentsniff.html)
-   [Cross-Channel Scripting and Reverse Cross-Channel Scripting](https://www.blackhat.com/presentations/bh-usa-09/BOJINOV/BHUSA09-Bojinov-EmbeddedMgmt-PAPER.pdf)
-   [Attacks on JavaScript Mashup Communication](https://www.ieee-security.org/TC/W2SP/2009/papers/s1p3.pdf)
-   [Code-Injection Attacks in Browsers Supporting Policies (return-to-JavaScript)](https://www.ieee-security.org/TC/W2SP/2009/papers/s3p1.pdf)
-   [Unraveling Unicode: A Bag of Tricks for Bug Hunting](https://www.blackhat.com/presentations/bh-usa-09/WEBER/BHUSA09-Weber-UnicodeSecurityPreview-SLIDES.pdf)
-   [A Wolf in Sheep's Clothing: The Dangers of Persistent Web Browser Storage](https://blackhat.com/presentations/bh-dc-09/Sutton/blackhat-dc-09-Sutton-persistent-storage.pdf)
-   [PHPIDS unserialize() Vulnerability: Reusing Framework Object Chains](https://sektioneins.de/advisories/advisory-022009-phpids-unserialize-vulnerability.html) — Stefan Esser
-   [OpenID association poisoning](https://blog.nerdbank.net/2009/03/08/openid-association-poisoning/) — Andrew Arnott
-   [Weaponizing the Web / MonkeyFist](https://www.blackhat.com/presentations/bh-usa-09/HAMIEL/BHUSA09-Hamiel-WeaponizingWeb-SLIDES.pdf) — Nathan Hamiel and Shawn Moyer
-   [Breaking the Security Myths of Extended Validation SSL](https://www.blackhat.com/presentations/bh-usa-09/SOTIROV/BHUSA09-Sotirov-AttackExtSSL-SLIDES.pdf) — Alexander Sotirov and Mike Zusman
